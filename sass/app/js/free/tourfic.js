(function ($, win) {
    $(document).ready(function () {
        ...
        */
        ...
        $('.tf-single-template__three .acr-inc, .tf-archive-booking-form__style-2 .acr-inc, .tf-single-template__three .acr-dec, .tf-archive-booking-form__style-2 .acr-dec').on('click', function () {
        ...
        $(document).on("mouseup", function (e) {
            var container = $(".tf-single-template__three .tf_acrselection-wrap, .tf-archive-booking-form__style-2 .tf_acrselection-wrap");
            if (!container.is(e.target) && container.has(e.target).length === 0) {
                $(".tf-single-template__three .tf-booking-form-guest-and-room .tf_acrselection-wrap, .tf-archive-booking-form__style-2 .tf-booking-form-guest-and-room .tf_acrselection-wrap").removeClass("tf-show");
            }
        });
        $(".tf-single-template__three .tf-booking-form-guest-and-room, .tf-archive-booking-form__style-2 .tf-booking-form-guest-and-room").on("click", function () {
            $(".tf-single-template__three .tf-booking-form-guest-and-room .tf_acrselection-wrap, .tf-archive-booking-form__style-2 .tf-booking-form-guest-and-room .tf_acrselection-wrap").addClass("tf-show");
        });
