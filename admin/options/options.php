...
function tf_add_custom_permalink_fields()
{
    ...
    add_settings_section('tf_permalink', __('Tourfic Permalinks', TFD), 'tf_permalink_section_callback', 'permalink');
    // Tour
    add_settings_field('tour_slug', __('Tour slug', TFD), 'tf_tour_slug_field_callback', 'permalink', 'tf_permalink', array('label_for' => 'tour_slug'));
    // Hotel
    add_settings_field('hotel_slug', __('Hotel slug', TFD), 'tf_hotel_slug_field_callback', 'permalink', 'tf_permalink', array('label_for' => 'hotel_slug'));
}
...
{
    _e('If you like, you may enter custom structures for your archive & single URLs here.', TFD);
}
...
{ ?>
    ...
    <p class="description"><?php printf(__('Leave blank for default value: %1stours%2s', TFD), '<code>', '</code>'); ?></p>
<?php }
// Hotel slug callback
...
{ ?>
    ...
    <p class="description"><?php printf(__('Leave blank for default value: %1shotels%2s', TFD), '<code>', '</code>'); ?></p>
<?php }
