...
class TF_Handle_Emails {
    ...
    public function send_confirmation_email_pro($order_id){
        ...
        $enable_vendor_email               = !empty( $email_template_settings['enable_vendor_email'] ) ? $email_template_settings['enable_vendor_email'] : '';
        $enable_customer_email             = !empty( $email_template_settings['enable_customer_email'] ) ? $email_template_settings['enable_customer_email'] : '';
        ...
        if( ! empty ( $enable_vendor_email ) && $enable_vendor_email == 1 ){
            //email settings metabox value
        ...
        if( ! empty ( $enable_customer_email ) && $enable_customer_email == 1 ){
            //email settings metabox value
