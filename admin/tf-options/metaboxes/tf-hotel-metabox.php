	...
	'sections'  => array(
		'general' => array(
			...
			'fields' => array(
				...
				array(
					'id'    => 'hotel-affiliate-heading',
					'type'  => 'heading',
					'label' => __( 'Affiliate Settings', 'tourfic' ),
					'subtitle' => __( 'If you are an affiliate marketer, you can use this section to add your affiliate links to this hotel.', 'tourfic' ),
				),
				array(
					'id'      => 'hotel-affiliate-docs',
					'type'    => 'notice',
					'style'   => 'success',
					'content' => __( 'If anything is not clear, please', 'tourfic' ) . ' <a href="https://themefic.com/docs/tourfic/settings/affiliate/" target="_blank" class="tf-admin-btn tf-btn-secondary tf-small-btn"><strong>' . __( 'Check our Documentation', 'tourfic' ) . '</strong></a>',
				),
				array(
					'id'          => '',
					'type'        => 'switch',
					'label'       => __( 'Enable Affiliate Link', 'tourfic' ),
					'subtitle'    => __( 'Enable this option to add an affiliate link to this hotel.', 'tourfic' ),
					'label_on'    => __( 'Yes', 'tourfic' ),
					'label_off'   => __( 'No', 'tourfic' ),
					'default'     => true,
					'is_pro'      => true,
				...
				array(
					'id'         => '',
					'type'       => 'select',
					'label'      => __( 'Affiliate Type', 'tourfic' ),
					'options'    => array(
						'booking'   => __( 'Booking.com', 'tourfic' ),
						'agoda'     => __( 'Agoda.com', 'tourfic' ),
						'expedia'   => __( 'Expedia.com', 'tourfic' ),
						'airbnb'    => __( 'Airbnb.com', 'tourfic' ),
					),
					'default'    => 'booking',
				...
				array(
					'id'          => '',
					'type'        => 'text',
					'label'       => __( 'Affiliate Link', 'tourfic' ),
					'subtitle'    => __( 'Enter your affiliate link here.', 'tourfic' ),
					'placeholder' => __( 'http://', 'tourfic' ),
					'default'     => '',
					'dependency'  => array( 'affiliate', '==', true ),
					'is_pro'      => true,
				),
