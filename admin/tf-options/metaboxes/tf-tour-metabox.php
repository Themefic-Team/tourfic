		...
		'tour_extra'           => array(
			...
			'fields' => array(
				...
				array(
					...
					'notice' => 'info',
					'icon' => 'ri-lightbulb-flash-fill',
					'content' => esc_html__( 'Are you interested in enriching your tour offerings with exciting services? With our Pro package, you can easily add exciting activities such as paragliding, along with meals and hotel accommodations, through our Tour Extra Services. This feature allows you to customize and expand your services as much as you want, providing a better experience for your customers.', 'tourfic' ) . ' <a href="https://tourfic.com/" target="_blank"><strong>' . esc_html__( 'Upgrade to our Pro package today to take advantage of these fantastic options!', 'tourfic' ) . '</strong></a>',
				),
			),
		),
		...
		'price'                => array(
			...
			'fields' => array(
				...
				array(
					...
					'notice' => 'info',
					'icon' => 'ri-lightbulb-flash-fill',
					'content' => esc_html__( 'Are you interested in collecting upfront or partial payments for your tours? Our Deposit option allows you to set an upfront payment, either as a percentage or a fixed amount, which travelers can pay at the time of booking. ', 'tourfic' ) . ' <a href="https://tourfic.com/" target="_blank"><strong>' . esc_html__( 'Upgrade to our Pro package today to take advantage of this fantastic option', 'tourfic' ) . '</strong></a>',
				),
			),
		),
