                        ...
                        <div class="tf-modal-body">
                            <div class="tf-icon-wrapper">
                                <ul class="tf-icon-tab-list">
                                    <li class="tf-icon-tab active" data-tab="tf-icon-tab-all">
                                        <i class="ri-grid-fill"></i><?php esc_html_e( 'All Icons', 'tourfic' ); ?>
                                    </li>
									<?php
									$count     = 0;
									...
									foreach ( $icon_list as $key => $value ) :
										if ( $value['icons'] ):
											?>
                                            <li class="tf-icon-tab" data-tab="tf-icon-tab-<?php echo esc_attr( $key ) ?>">
                                ...
                                <div class="tf-icon-tab-content">
                                    <div class="tf-icon-tab-pane active" id="tf-icon-tab-all">
									...
									foreach ( $icon_list as $key => $value ) :
										?>
                                        <div class="tf-icon-tab-pane" id="tf-icon-tab-<?php echo esc_attr( $key ) ?>">
                                            <ul class="tf-icon-list">
												<?php
												if ( $value['icons'] ):
													foreach ( $value['icons'] as $icon ) :
