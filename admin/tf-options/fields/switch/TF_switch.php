	...
	class TF_switch extends TF_Fields {
		...
		public function render() {
            ...
            <label class="tf-switch-label" <?php echo wp_kses_post($width); ?>>
                <input type="checkbox" name="<?php echo esc_attr( $this->field_name() ); ?>" value="<?php echo $this->value; ?>" data-depend-id="<?php echo esc_attr( $this->field['id'] ); ?>" class="tf-switch" <?php checked( $this->value, 1 ); ?> />
