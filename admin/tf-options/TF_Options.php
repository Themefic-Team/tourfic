...
if ( ! class_exists( 'TF_Options' ) ) {
	class TF_Options {
		...
		public function field( $field, $value, $settings_id = '', $parent = '' ) {
			...
			?>
            <div class="tf-field tf-field-<?php echo esc_attr( $field['type'] ); ?> <?php echo esc_attr( $class ); ?> <?php echo !empty($visible) ? $visible : ''; ?>" <?php echo !empty($depend) ? $depend : ''; ?> <?php echo !empty($data_value) && $tf_meta_box_dep_value[$data_controller]!=$data_value ? 'style="display:none"' : ''; ?>>
