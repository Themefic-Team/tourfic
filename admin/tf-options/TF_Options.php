...
if ( ! class_exists( 'TF_Options' ) ) {
	class TF_Options {
		...
		public function tf_options_admin_enqueue_scripts($screen) {
            $tf_settings_screens = array('toplevel_page_tf_settings', 'tourfic-settings_page_tf_get_help', 'tourfic-settings_page_tf_license_info', 'tourfic-settings_page_tf_dashboard' );
			...
			//Css
			if(in_array($screen, $tf_settings_screens)){
