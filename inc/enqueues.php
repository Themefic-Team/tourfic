...
if (!function_exists('tf_enqueue_scripts')) {
    function tf_enqueue_scripts()
    {
         ...
         * Custom
         */
        wp_enqueue_style(TFD, TF_ASSETS_URL . 'css/tourfic' . $min_css . '.css', '', TOURFIC);
        wp_enqueue_script(TFD, TF_ASSETS_URL . 'js/tourfic' . $min_js . '.js', '', TOURFIC, true);
        wp_localize_script(
            TFD,
            'tf_params',
            array(
                ...
                'ajax_result_success' => __('Refreshed Successfully!', TFD),
                'wishlist_add' => __('Adding to wishlist...', TFD),
                'wishlist_added' => __('Item added to wishlist.', TFD),
                'wishlist_add_error' => __('Failed to add in wishlist!', TFD),
                'wishlist_removed' => __('Item removed from wishlist', TFD),
                'wishlist_remove_error' => __('Failed to remove from wishlist!', TFD),
                'field_required' => __('This field is required!', TFD),
                'adult' => __('Adult', TFD),
                'children' => __('Children', TFD),
                'infant' => __('Infant', TFD),
                'room' => __('Room', TFD),
                'sending_ques' => __('Sending your question...', TFD),
            )
        );
        ...
        wp_add_inline_script(TFD, $inline_scripts);
    }
