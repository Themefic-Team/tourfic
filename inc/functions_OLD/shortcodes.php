        ...
        <section id="recomended_section_wrapper">
            <div class="recomended_inner">
				...
				<?php foreach ( $locations as $term ) {
					...
					$image_url = ! empty( $meta['image'] ) ? $meta['image'] : TF_APP_ASSETS_URL . 'images/feature-default.jpg';
            ...
            <div class="tf-slider-items-wrapper">
				<?php while ( $hotel_loop->have_posts() ) {
                    ...
                    <div class="tf-slider-item"
                         style="background-image: url(<?php echo ! empty( get_the_post_thumbnail_url( $post_id, 'full' ) ) ? get_the_post_thumbnail_url( $post_id, 'full' ) : TF_APP_ASSETS_URL . '/images/feature-default.jpg'; ?>);">
        ...
        <div class="tf-widget-slider recent-hotel-slider">
            ...
            <div class="<?php echo esc_attr( $slider_activate ); ?>">
				<?php while ( $post_loop->have_posts() ) :
					...
					?>
                    <div class="tf-slider-item" style="background-image: url(<?php echo ! empty( get_the_post_thumbnail_url( $post_id, 'full' ) ) ? get_the_post_thumbnail_url( $post_id, 'full' ) : TF_APP_ASSETS_URL . '/images/feature-default.jpg'; ?>);">
                        <div class="tf-slider-content">
                            <div class="tf-slider-desc">
