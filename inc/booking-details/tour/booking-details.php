        ...
        <div class="tf-filter-options">
            <div class="tf-order-status-filter">
                <select class="tf-tour-filter-options tf-post-id-filter-options" name="tours">
                    <option value=""><?php esc_html_e("Tour name", "tourfic"); ?></option>
                    <?php 
                    $tftours_list = array(
                        'posts_per_page' => - 1,
                        'post_type'      => 'tf_tours',
    ...
    <table class="wp-list-table table" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th id="odetails">
                    <?php esc_html_e("Tour name", "tourfic"); ?>
                </th>
                <th id="cdetails">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php echo esc_html(gmdate('F d, Y',strtotime($tour['order_date']))); ?>
                </td>
                ...
                <td>
                    <?php 
                    $actions_details = '<a href="'.admin_url().'edit.php?post_type=tf_tours&amp;page=tf_tours_booking&amp;order_id='.$tour['order_id'].'&amp;book_id='.$tour['id'].'&amp;action=preview&nonce='.esc_attr( wp_create_nonce( 'tf_booking_details' ) ).'" class="tf_booking_details_view"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
