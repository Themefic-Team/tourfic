<div class="tf-booking-header-filter">
    ...
    <form class="tf-right-search-filter">
        <input type="number" value="<?php echo !empty($_GET['post']) ? esc_attr( $_GET['post'] ) : ''; ?>" placeholder="Search by Tour ID" id="tf-searching-key">
...
<table class="wp-list-table table" cellpadding="0" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?php 
                $billing_info = json_decode($tour['billing_details']);
                $billing_details = "";
