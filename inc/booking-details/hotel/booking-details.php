...
<table class="wp-list-table table" cellpadding="0" cellspacing="0">
    ...
    <tbody>
        <?php foreach($hotel_orders_result as $hotel){ ?>
        <tr>
            ...
            <td>
                ...
                if ( $current_user_role == 'administrator' ) {
                    $actions_details .= '<a href="'.admin_url().'post.php?post='.$hotel['order_id'].'&amp;action=edit" class="tf_booking_email_sending"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
