    ...
    <table class="wp-list-table table" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=tf_apartment&page=tf_apartment_booking&order_id=' . esc_attr( $apartment['order_id'] ) . '&book_id=' . esc_attr( $apartment['id'] ) . '&action=preview' ) ); ?>">
                        <?php echo esc_html( $apartment['order_id'] ); ?>
                    </a>
                </td>
                <td>
                    <?php echo esc_html(get_the_title($apartment['post_id'])); ?>
                </td>
                <td>
                    <?php 
                ...
                <td>
                    <?php 
                    $actions_details = '<a href="'.admin_url().'edit.php?post_type=tf_apartment&amp;page=tf_apartment_booking&amp;order_id='.$apartment['order_id'].'&amp;book_id='.$apartment['id'].'&amp;action=preview&nonce='.esc_attr( wp_create_nonce( 'tf_booking_details' ) ).'" class="tf_booking_details_view"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    echo wp_kses($actions_details, tf_kses_svg_esc_rule() );
                    ?>
                </td>
            </tr>
            <?php 
            ...
            <tr>
                <th colspan="8">
                    <ul class="tf-booking-details-pagination">
                        ...
                        ?>
                            <li class="active">
                                <a href="<?php echo esc_url(tf_booking_details_pagination( $i )); ?>"><?php echo esc_attr($i); ?></a>
                            </li>
                        <?php } else{ ?>
                            <li>
                            <a href="<?php echo esc_url(tf_booking_details_pagination( $i )); ?>"><?php echo esc_attr($i); ?></a>
