<div class="tf-booking-header-filter">
    ...
    <form class="tf-right-search-filter">
        <input type="number" value="<?php echo !empty($_GET['post']) ? esc_attr( $_GET['post'] ) : ''; ?>" placeholder="Search by Apartment ID" id="tf-searching-key">
...
<table class="wp-list-table table" cellpadding="0" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?php 
                $billing_info = json_decode($apartment['billing_details']);
                $billing_details = "";
            ...
            <td>
                <?php echo date('F d, Y',strtotime($apartment['order_date'])); ?>
            </td>
            ...
            <td>
                ...
                if ( $current_user_role == 'administrator' ) {
                    $actions_details .= '<a href="'.admin_url().'post.php?post='.$apartment['order_id'].'&amp;action=edit" class="tf_booking_email_sending"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                $actions_details .= '<a href="'.admin_url().'edit.php?post_type=tf_apartment&amp;page=tf_apartment_booking&amp;order_id='.$apartment['order_id'].'&amp;book_id='.$apartment['id'].'&amp;action=preview" class="tf_booking_details_view"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
