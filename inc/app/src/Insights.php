...
class Insights
{
    ...
    public function admin_notice()
    {
        ...
        echo "<script type='text/javascript'>jQuery('." . esc_html( $this->client->slug ) . "-insights-data-we-collect').on('click', function(e) {
                e.preventDefault();
                        ...
                        <?php foreach ($reasons as $reason) { ?>
                            <li data-placeholder="<?php echo esc_attr($reason['placeholder']); ?>">
                                <label>
                                    ...
                                    <div class="wd-de-reason-icon"><?php echo esc_attr( $reason['icon'] ); ?></div>
                                    <div class="wd-de-reason-text"><?php echo esc_attr( $reason['text'] ); ?></div>
                                </label>
                            </li>
                        <?php } ?>
                    </ul>
                ...
                $(function() {
                    ...
                    modal.on('click', 'button.wd-dr-submit-modal', function(e) {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {
                                nonce: '<?php echo esc_html( wp_create_nonce('appsero-security-nonce') ); ?>',
