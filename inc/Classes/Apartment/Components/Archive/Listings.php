...
/**
 * Centralized apartment archive listing renderer.
...
class Listings {
            ...
            <div class="tf-archive-available-rooms-head tf-available-rooms-head">
                <?php if ( 'yes' === $show_total_result ) : ?>
                    <h3 class="tf-total-results">
                        ...
                        <?php esc_html_e( 'apartments available', 'tourfic' ); ?>
                    </h3>
                <?php endif; ?>
    ...
    public static function render_design_2( $query = null, $settings = [], $builder = '' ) {
        ...
        $post_count      = $query->post_count;
        $tf_defult_views = ! empty( Helper::tf_data_types( Helper::tfopt( 'tf-template' ) )['apartment_archive_view'] )
            ? Helper::tf_data_types( Helper::tfopt( 'tf-template' ) )['apartment_archive_view']
            : 'list';
                                    ...
                                    <div class="tf-archive-top">
                                        <?php if ( 'yes' === $show_total_result ) : ?>
                                            <h5 class="tf-total-results">
                                                ...
                                                <?php esc_html_e( 'Apartments', 'tourfic' ); ?>
                                            </h5>
                                        <?php endif; ?>
                                            ...
                                            if ( ! empty( $map ) ) {
                                                ...
                                                <div class="tf-map-item">
                                                    <div class="tf-map-item-thumb">
                                                        ...
                                                        <?php if ( ! empty( $discount_price ) ) : ?>
                                                            <div class="tf-map-item-discount">
                                                                <?php echo 'percent' === $discount_type ? wp_kses_post( $discount_price . '%' ) : wp_kses_post( wc_price( $discount_price ) ); ?>
                                                    ...
                                                    <div class="tf-map-item-content">
                                                        ...
                                                        <?php \Tourfic\App\TF_Review::tf_archive_single_rating( '', isset( $settings['design_apartment'] ) ? $settings['design_apartment'] : '' ); ?>
                                                    </div>
                                                </div>
                                                <?php
        ...
        <div class="tf-search-left">
            <div class="tf-action-top">
                ...
                <div class="tf-list-grid">
                    <?php if ( 'yes' === $listing_layout_toggle ) : ?>
                        <a href="#list-view" data-id="list-view" class="change-view <?php echo 'list' === $listing_layout ? esc_attr( 'active' ) : ''; ?>" title="<?php esc_attr_e( 'List View', 'tourfic' ); ?>"><i class="fas fa-list"></i></a>
                        <a href="#grid-view" data-id="grid-view" class="change-view <?php echo 'grid' === $listing_layout ? esc_attr( 'active' ) : ''; ?>" title="<?php esc_attr_e( 'Grid View', 'tourfic' ); ?>"><i class="fas fa-border-all"></i></a>
                    <?php endif; ?>
