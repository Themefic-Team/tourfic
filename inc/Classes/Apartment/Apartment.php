						...
						<div class="tf_destination_fields">
							<label class="tf_label_location">
								...
								<div class="tf_form_inners tf_form-inner">
									...
									<input type="text" required="" name="place-name" id="tf-apartment-location" class="tf-apartment-location" placeholder="<?php esc_html_e( 'Enter Location', 'tourfic' ); ?>" value="">
                ...
                <fieldset class="tf-search__form__fieldset">
                    ...
                    <div class="tf-search__form__fieldset__left">
                        ...
                        <div class="tf-search__form__field">
                            <input type="text" required="" name="place-name" id="tf-apartment-location" class="tf-search__form__input tf-apartment-location" placeholder="<?php esc_html_e('Where you wanna stay?', 'tourfic'); ?>" value="">
                            <input type="hidden" name="place" class="tf-place-input">
