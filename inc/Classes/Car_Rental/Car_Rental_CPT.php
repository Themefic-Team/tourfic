...
class Car_Rental_CPT extends \Tourfic\Core\Post_Type {
	...
	public function __construct() {
		...
		$this->set_post_args( array(
			...
			'menu_position' => 26.5,
			'supports'      => apply_filters( 'tourfic_carrental_supports', array( 'title', 'editor', 'thumbnail', 'comments', 'author' ) ),
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_carrental_location_slug', 'carrental-location' ),
				'capability'  => array(
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_carrental_brand_slug', 'carrental-brand' ),
				'capability'  => array(
					'assign_terms' => 'edit_tf_carrental',
					'edit_terms'   => 'edit_tf_carrental',
				),
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_carrental_fuel_type_slug', 'carrental-features' ),
				'capability'  => array(
					'assign_terms' => 'edit_tf_carrental',
					'edit_terms'   => 'edit_tf_carrental',
				),
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_carrental_category_slug', 'carrental-category' ),
				'capability'  => array(
					'assign_terms' => 'edit_tf_carrental',
					'edit_terms'   => 'edit_tf_carrental',
				),
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_carrental_engine_year_slug', 'carrental-year' ),
				'capability'  => array(
					'assign_terms' => 'edit_tf_carrental',
					'edit_terms'   => 'edit_tf_carrental',
				),
	...
	private function get_carrental_slug() {
		...
		update_option( "tourfic_car_slug", $tf_carrental_setting_permalink_slug );

		return apply_filters( 'tourfic_car_slug', get_option( 'tourfic_car_slug' ) );
	}
