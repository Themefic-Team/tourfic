...
?>
        ...
        <?php } elseif (!empty($design) && 4 == $design) { ?>
            ...
            <form class="tf-archive-search-box-wrapper tf_car-shortcode-design-4 tf-shortcode-design-4 <?php echo esc_attr($classes); ?>" id="tf_car_booking" method="get" autocomplete="off" action="<?php echo esc_url(Helper::tf_booking_search_action()); ?>">
                <div class="tf-date-select-box tf-flex tf-flex-gap-8 tf-date-selection-form">
                    <div class="tf-date-single-select tf-flex tf-flex-gap-8 tf-flex-space-bttn tf-pick-drop-location">
                        <div class="tf-select-date">
                            <div class="tf-flex tf-flex-gap-4">
