					...
					<div class="tf_form_innerbody">
						<div class="tf_form_fields">
							...
							<div class="tf_checkin_date">
								...
								<input type="text" name="check-in-out-date" class="tf-tour-check-in-out-date" id="check-in-out-date" onkeypress="return false;" placeholder="<?php esc_html_e('Select Date', 'tourfic'); ?>" <?php echo Helper::tfopt('date_tour_search') ? 'required' : ''; ?>>
							</div>
