...
class Tour_CPT extends \Tourfic\Core\Post_Type {
	...
	public function __construct() {
		...
		$this->set_post_args( array(
			...
			'menu_position' => 26.3,
			'supports'      => apply_filters( 'tourfic_tours_supports', array( 'title', 'editor', 'thumbnail', 'comments', 'author' ) ),
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_tour_destination_slug', 'tour-destination' ),
				'capability'    => array(
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_tour_attraction_slug', 'tour-attraction' ),
				'capability'    => array(
					'assign_terms' => 'edit_tf_tours',
					'edit_terms'   => 'edit_tf_tours',
				),
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_tour_activities_slug', 'tour-activities' ),
				'capability'    => array(
					'assign_terms' => 'edit_tf_tours',
					'edit_terms'   => 'edit_tf_tours',
				),
			...
			array(
				...
				'rewrite_slug'  => apply_filters( 'tourfic_tour_features_slug', 'tour-features' ),
				'capability'    => array(
					'assign_terms' => 'edit_tf_tours',
					'edit_terms'   => 'edit_tf_tours',
				),
			...
			array(
				...
				'taxonomy'      => 'tour_type',
				'rewrite_slug'  => apply_filters( 'tourfic_tour_type_slug', 'tour-type' ),
				'capability'    => array(
					'assign_terms' => 'edit_tf_tours',
					'edit_terms'   => 'edit_tf_tours',
				),
	...
	private function get_tour_slug() {
		...
		update_option( "tourfic_tour_slug", $tf_tour_setting_permalink_slug );

		return apply_filters( 'tourfic_tours_slug', get_option( "tourfic_tour_slug" ) );
	}
