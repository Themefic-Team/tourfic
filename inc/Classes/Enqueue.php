...
class Enqueue {
	...
	function tf_enqueue_scripts() {
		...
		// $hotel_min_max_price = !empty(get_option( 'tf_hotel_min_max_price' )) ? get_option( 'tf_hotel_min_max_price' ) : array('min' => 0, 'max' => 1);
		...
		// $tour_min_max_price = !empty( get_option( 'tf_tours_min_max_price' ) ) ? get_option( 'tf_tours_min_max_price' ) : array('min' => 0, 'max' => 1);
		...
		// $tf_apartment_min_max_price = !empty( get_option( 'tf_apt_min_max_price' ) ) ? get_option( 'tf_apt_min_max_price' ) : array('min' => 0, 'max' => 1);
	...
	public function tf_options_admin_enqueue_scripts( $screen ) {
		...
		if ( in_array( $screen, $tf_options_screens ) || in_array( $post_type, $tf_options_post_type ) ) {
			...
			if( $swal_cdn ) {
				wp_enqueue_style( 'tf-admin-sweet-alert', '//cdn.jsdelivr.net/npm/sweetalert2@11.6.8/dist/sweetalert2.min.css', '', TF_VERSION );
				wp_enqueue_script( 'tf-admin-sweet-alert', '//cdn.jsdelivr.net/npm/sweetalert2@11.6.8/dist/sweetalert2.min.js', array( 'jquery' ), TF_VERSION, true );
			} else {
