		...
		<div id="tf-booking-search-tabs" class="<?php echo esc_attr($classes) ?> <?php echo 2==$design ? esc_attr('tf-shortcode-design-2-tab') : ''; ?>">
			...
			<div class="tf-booking-form-tab">
				...
				<?php if ( ! in_array( 'hotel', $disable_services ) && Helper::tf_is_search_form_tab_type( 'hotel', $type ) && ! Helper::tf_is_search_form_single_tab( $type ) ) : ?>
					<button class="tf-tablinks btn-styled active" data-form-id="tf-hotel-booking-form"><?php echo esc_html(apply_filters("tf_hotel_search_form_tab_button_text", esc_html__('Hotel', 'tourfic' ))); ?></button>
				<?php endif; ?>
				...
				<?php if ( ! in_array( 'tour', $disable_services ) && Helper::tf_is_search_form_tab_type( 'tour', $type ) && ! Helper::tf_is_search_form_single_tab( $type ) ) : ?>
					<button class="tf-tablinks btn-styled" data-form-id="tf-tour-booking-form"><?php echo esc_html(apply_filters("tf_tour_search_form_tab_button_text", esc_html__('Tour', 'tourfic' ))); ?></button>
				<?php endif ?>
				...
				<?php if ( ! in_array( 'apartment', $disable_services ) && Helper::tf_is_search_form_tab_type( 'apartment', $type ) && ! Helper::tf_is_search_form_single_tab( $type ) ) : ?>
					<button class="tf-tablinks btn-styled" data-form-id="tf-apartment-booking-form"><?php echo esc_html(apply_filters("tf_apartment_search_form_tab_button_text", esc_html__('Apartment', 'tourfic' ))); ?></button>
				<?php endif ?>
			...
			<?php if ( ! Helper::tf_is_search_form_single_tab( $type ) ): ?>
				...
				<div class="tf-booking-form-tab-mobile">
					<select name="tf-booking-form-tab-select" id="">
						...
						<?php if ( ! in_array( 'hotel', $disable_services ) && Helper::tf_is_search_form_tab_type( 'hotel', $type ) && ! Helper::tf_is_search_form_single_tab( $type ) ) : ?>
							<option value="tf-hotel-booking-form"><?php echo esc_html(apply_filters("tf_hotel_search_form_tab_button_text", esc_html__('Hotel', 'tourfic' ))); ?></option>
						<?php endif; ?>
						<?php if ( ! in_array( 'tour', $disable_services ) && Helper::tf_is_search_form_tab_type( 'tour', $type ) && ! Helper::tf_is_search_form_single_tab( $type ) ) : ?>
							<option value="tf-tour-booking-form"><?php echo esc_html(apply_filters("tf_tour_search_form_tab_button_text", esc_html__('Tour', 'tourfic' ))); ?></option>
						<?php endif ?>
						<?php if ( ! in_array( 'apartment', $disable_services ) && Helper::tf_is_search_form_tab_type( 'apartment', $type ) && ! Helper::tf_is_search_form_single_tab( $type ) ) : ?>
							<option value="tf-apartment-booking-form"><?php echo esc_html(apply_filters("tf_apartment_search_form_tab_button_text", esc_html__('Apartment', 'tourfic' ))); ?></option>
						<?php endif ?>
