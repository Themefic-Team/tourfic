					...
					<div id="tf-booking-search-tabs" class="<?php echo esc_attr($classes) . 'tf-search-tabs__design--' . esc_attr($design) ?> <?php echo 2 == $design ? esc_attr('tf-shortcode-design-2-tab') : ''; ?>">
						...
						<div class="tf-booking-form-tab <?php echo esc_attr('design-' . $design . $tf_tabs_class); ?>">
							...
							<?php if (! in_array('hotel', $disable_services) && Helper::tf_is_search_form_tab_type('hotel', $type) && ! Helper::tf_is_search_form_single_tab($type)) : ?>
								<button class="tf-tablinks tf_btn tf_btn_small tf_btn_secondary active" data-form-id="tf-hotel-booking-form"><?php esc_html_e(apply_filters("tf_hotel_search_form_tab_button_text", $hotel_tab_title), 'tourfic'); ?></button>
							<?php endif; ?>
							...
							<?php if (! in_array('tour', $disable_services) && Helper::tf_is_search_form_tab_type('tour', $type) && ! Helper::tf_is_search_form_single_tab($type)) : ?>
								<button class="tf-tablinks tf_btn tf_btn_small tf_btn_secondary" data-form-id="tf-tour-booking-form"><?php esc_html_e(apply_filters("tf_tour_search_form_tab_button_text", $tour_tab_title), 'tourfic'); ?></button>
							<?php endif ?>
							...
							<?php if (! in_array('apartment', $disable_services) && Helper::tf_is_search_form_tab_type('apartment', $type) && ! Helper::tf_is_search_form_single_tab($type)) : ?>
								<button class="tf-tablinks tf_btn tf_btn_small tf_btn_secondary" data-form-id="tf-apartment-booking-form"><?php esc_html_e(apply_filters("tf_apartment_search_form_tab_button_text", $apartment_tab_title), 'tourfic'); ?></button>
							<?php endif ?>
							...
							<?php if (! in_array('carrentals', $disable_services) && Helper::tf_is_search_form_tab_type('carrentals', $type) && ! Helper::tf_is_search_form_single_tab($type)) : ?>
								<button class="tf-tablinks tf_btn tf_btn_small tf_btn_secondary" data-form-id="tf-car-booking-form"><?php esc_html_e(apply_filters("tf_car_search_form_tab_button_text", $car_tab_title), 'tourfic'); ?></button>
							<?php endif ?>
