							...
							<div class="tf-slider-content">
								<div class="tf-slider-desc">
									...
									<div class="tf-recent-room-price">
										...
										<?php echo $min_price["min"] == $discounted_price ? wp_kses_post( tf_price($min_price["min"]) ) : '<del>' . wp_kses_post( tf_price($min_price["min"]) ) . '</del>' . ' ' . wp_kses_post( tf_price( $discounted_price ) ); ?>
                                    </div>
								</div>
							</div>
						</div>
