...
class Price_Filter extends \WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if( is_post_type_archive('tf_tours') || is_post_type_archive('tf_hotel') || is_post_type_archive('tf_apartment') || is_post_type_archive('tf_carrental') || ( !empty( $tf_query_taxonomy ) ) ){
            ...
            if( !is_post_type_archive('tf_hotel') && !is_post_type_archive('tf_tours') && !is_post_type_archive('tf_apartment') && !is_post_type_archive('tf_carrental') && in_array( 'tf_hotel', $tf_query_taxonomy, true ) ){
                ?>
                    <div class="tf-widget-title">
            ...
            if( !is_post_type_archive('tf_hotel') && !is_post_type_archive('tf_tours') && !is_post_type_archive('tf_apartment') && !is_post_type_archive('tf_carrental') && in_array( 'tf_tours', $tf_query_taxonomy, true ) ){
                ?>
                    <div class="tf-widget-title">
                        <span><?php esc_html_e("Tour Price Range","tourfic"); ?> (<?php echo wp_kses_post(get_woocommerce_currency_symbol()); ?>)</span>
                    </div>
            ...
            if( !is_post_type_archive('tf_hotel') && !is_post_type_archive('tf_tours') && !is_post_type_archive('tf_apartment') && !is_post_type_archive('tf_carrental') && in_array( 'tf_apartment', $tf_query_taxonomy, true ) ){
                ?>
                    <div class="tf-widget-title">
                        <span><?php esc_html_e("Apartment Price Range","tourfic"); ?> (<?php echo wp_kses_post(get_woocommerce_currency_symbol()); ?>)</span>
                    </div>
            ...
            if( !is_post_type_archive('tf_hotel') && !is_post_type_archive('tf_tours') && !is_post_type_archive('tf_apartment') && !is_post_type_archive('tf_carrental') && in_array( 'tf_carrental', $tf_query_taxonomy, true ) ){
                ?>
                    <div class="tf-widget-title">
                        <span><?php esc_html_e("Price Range","tourfic"); ?> (<?php echo wp_kses_post(get_woocommerce_currency_symbol()); ?>)</span>
                    </div>
