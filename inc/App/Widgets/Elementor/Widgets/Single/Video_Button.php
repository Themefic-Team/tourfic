...
class Video_Button extends Widget_Base {
	...
	public function get_name() {
		return 'tf-single-video-button';
	}

	public function get_title() {
		return esc_html__( 'Video Button', 'tourfic' );
	}
	...
	protected function register_controls() {
		...
		do_action( 'tf/single-video-button/before-style-controls', $this );
		$this->tf_video_button_style_controls();
		do_action( 'tf/single-video-button/after-style-controls', $this );
	}

	protected function tf_content_layout_controls(){
        $this->start_controls_section('tf_video_button_content',[
            'label' => esc_html__('Video Button', 'tourfic'),
        ]);

        do_action( 'tf/single-video-button/before-content/controls', $this );
	    ...
	    do_action( 'tf/single-video-button/after-content/controls', $this );

        $this->end_controls_section();
    }

    protected function tf_video_button_style_controls() {
	...
	protected function render() {
        ...
        <div class="tf-single-action-btns featured-column tf-video-box">
            <a class="tf-tour-video" id="featured-video" data-fancybox="tour-video" href="<?php echo esc_url($video); ?>">
                ...
                <?php echo isset($settings['label']) ? esc_html($settings['label']) : esc_html__('Video', 'tourfic'); ?>
            </a>
        </div>
        <?php 
        endif;
