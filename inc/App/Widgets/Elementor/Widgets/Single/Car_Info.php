 ...
 * car info
 */
class Car_Info extends Widget_Base {
	...
	public function get_name() {
		return 'tf-single-car-info';
	}

	public function get_title() {
		return esc_html__( 'Car Info', 'tourfic' );
	}
	...
	public function get_style_depends(){
		return ['tf-elementor-single-car-info'];
	}
	...
	protected function tf_content_layout_controls(){
        $this->start_controls_section('tf_post_car_info_content',[
