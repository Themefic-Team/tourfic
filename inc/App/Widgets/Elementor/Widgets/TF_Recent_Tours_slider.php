...
class TF_Recent_Tours_slider extends \Elementor\Widget_Base {
	...
	protected function render() {
        ...
        echo do_shortcode('[tourfic_recent_tour title="' .$title. '" subtitle="' .$subtitle. '" count="' .$count. '" slidestoshow="' .$slidestoshow. '"]');

		if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ): ?>
			<script>
				jQuery('.recent-tour-slider .tf-slider-items-wrapper').slick({
					dots: true,
					arrows: false,
					infinite: true,
					speed: 300,
