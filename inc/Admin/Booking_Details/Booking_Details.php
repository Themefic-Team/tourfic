            ...
            <table class="wp-list-table table" cellpadding="0" cellspacing="0">
				...
				foreach ( $tf_order_details_result as $tf_order ) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo admin_url(); ?>edit.php?post_type=tf_hotel&amp;page=tf_hotel_booking&amp;order_id=<?php echo esc_attr( $tf_order['order_id'] ); ?>&amp;book_id=<?php echo esc_attr( $tf_order['id'] ); ?>&amp;action=preview">
                        ...
                        <td>
							<?php
							$actions_details = '<a href="' . admin_url() . 'edit.php?post_type=tf_hotel&amp;page=tf_hotel_booking&amp;order_id=' . $tf_order['order_id'] . '&amp;book_id=' . $tf_order['id'] . '&amp;action=preview" class="tf_booking_details_view"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
