...
class Booking_Details {
	...
	protected $booking_args;

	public function __construct( $booking_args = array() ) {
		$this->booking_args = $booking_args;
		add_action( 'admin_menu', array( $this, 'tf_add_booking_details_submenu' ) );
	}
            ...
            <table class="wp-list-table table" cellpadding="0" cellspacing="0">
				...
				foreach ( $tf_order_details_result as $tf_order ) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo admin_url(); ?>edit.php?post_type=<?php echo $this->booking_args['post_type']; ?>&amp;page=<?php echo $this->booking_args['menu_slug']; ?>&amp;order_id=<?php echo esc_attr( $tf_order['order_id'] ); ?>&amp;book_id=<?php echo esc_attr( $tf_order['id'] ); ?>&amp;action=preview">
								<?php echo esc_html( $tf_order['order_id'] ); ?>
                            </a>
                        </td>
                        <td>
							<?php echo get_the_title( $tf_order['post_id'] ); ?>
                        </td>
                        <td>
							<?php
                        ...
                        <td>
							<?php echo date( 'F d, Y', strtotime( $tf_order['order_date'] ) ); ?>
                        </td>
                        <td>
							<?php
	...
	function tf_single_booking_details( $booking_type, $tf_order_details ) { ?>
        <div class="tf-booking-details-preview">
            <div class="tf-details-preview-header">
                <div class="tf-back">
                    <a href="<?php echo get_admin_url( null, 'edit.php?post_type=' . $this->booking_args['post_type'] . '&page=' . $this->booking_args['menu_slug'] ); ?>">
                ...
                <div class="tf-booking-details">
                    ...
                    <div class="customers-order-date details-box">
                        ...
                        <div class="tf-grid-box tf-customer-details-boxs">
							...
							<?php } ?>
							<?php
							$tf_sorder_details = json_decode( $tf_order_details->order_details );
							if ( ! empty( $tf_sorder_details ) ) { ?>
                                <div class="tf-grid-single">
                                    ...
                                    <div class="tf-single-box">
                                        <table class="table">
											...
											<?php if ( ! empty( $tf_sorder_details->check_in ) ) { ?>
                                                <tr>
                                                    <th><?php _e( "Checkin", "tourfic" ); ?></th>
                                                    <td>:</td>
                                                    <td><?php echo esc_html( $tf_sorder_details->check_in ); ?></td>
                                                </tr>
											<?php } ?>
											<?php if ( ! empty( $tf_sorder_details->check_out ) ) { ?>
                                                <tr>
                                                    <th><?php _e( "Checkout", "tourfic" ); ?></th>
                                                    <td>:</td>
                                                    <td><?php echo esc_html( $tf_sorder_details->check_out ); ?></td>
                                                </tr>
											<?php } ?>
											<?php if ( ! empty( $tf_sorder_details->room ) ) { ?>
                                                <tr>
                                                    <th><?php _e( "Room", "tourfic" ); ?></th>
                                                    <td>:</td>
                                                    <td><?php echo esc_html( $tf_sorder_details->room ); ?></td>
                                                </tr>
											<?php } ?>
											<?php
											$tf_total_visitor = 0;
											$book_adult       = ! empty( $tf_sorder_details->adult ) ? $tf_sorder_details->adult : '';
											if ( ! empty( $book_adult ) ) {
											...
											<?php
											$book_children = ! empty( $tf_sorder_details->child ) ? $tf_sorder_details->child : '';
											...
											<?php
											if ( "tf_tours" == $this->booking_args['post_type'] ) {
												$book_infants = ! empty( $tf_sorder_details->infants ) ? $tf_sorder_details->infants : '';
											...
											<?php if ( ! empty( $tf_sorder_details->children_ages ) ) { ?>
                                                <tr>
                                                    <th><?php _e( "Child Ages", "tourfic" ); ?></th>
                                                    <td>:</td>
                                                    <td><?php echo esc_html( $tf_sorder_details->children_ages ); ?></td>
                                                </tr>
											<?php } ?>

											<?php if ( ! empty( $tf_sorder_details->airport_service_type ) ) { ?>
                                                <tr>
                                                    <th><?php _e( "Airport Service Type", "tourfic" ); ?></th>
                                                    <td>:</td>
                                                    <td><?php echo esc_html( $tf_sorder_details->airport_service_type ); ?></td>
                                                </tr>
											<?php } ?>
					...
					<?php if ( "tf_hotel" == $this->booking_args['post_type'] ) { ?>
                        <!-- Pricing Details -->
                        <div class="customers-order-date details-box">
                            <h4>
                                ...
                                <div class="tf-grid-single">
                                    <div class="tf-single-box">
                                        <table class="table">
											...
											<?php if ( ! empty( $tf_sorder_details->airport_service_fee ) ) { ?>
                                                <tr>
                                                    <th><?php _e( "Airport Service", "tourfic" ); ?></th>
                                                    <td>:</td>
                                                    <td><?php echo $tf_sorder_details->airport_service_fee; ?></td>
                                                </tr>
											<?php } ?>
											<?php
					...
					<?php if ( "tf_tours" == $this->booking_args['post_type'] ) { ?>
                                ...
                                <div class="tf-grid-single">
                                    <div class="tf-single-box">
                                        <table class="table">
											...
											<?php
											if ( ! empty( $tf_sorder_details->tour_extra ) ) {
												?>
                                                <tr>
                                                    <th><?php _e( "Extra", "tourfic" ); ?></th>
                                                    <td>:</td>
                                                    <td><?php echo $tf_sorder_details->tour_extra; ?></td>
                                                </tr>
											<?php } ?>
											<?php
											if ( ! empty( $tf_sorder_details->total_price ) ) { ?>
                        ...
                        <div class="customers-order-date details-box">
                            <h4>
								...
								<span>
									...
									<path d="M2.39662 15.0963C2.43491 14.7517 2.45405 14.5794 2.50618 14.4184C2.55243 14.2755 2.61778 14.1396 2.70045 14.0142C2.79363 13.8729 2.91621 13.7503 3.16136 13.5052L14.1666 2.49992C15.0871 1.57945 16.5795 1.57945 17.4999 2.49993C18.4204 3.4204 18.4204 4.91279 17.4999 5.83326L6.49469 16.8385C6.24954 17.0836 6.12696 17.2062 5.98566 17.2994C5.86029 17.3821 5.72433 17.4474 5.58146 17.4937C5.42042 17.5458 5.24813 17.5649 4.90356 17.6032L2.08325 17.9166L2.39662 15.0963Z"
                                          stroke="#003C79" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
									</svg>
									<?php _e( "Edit", "tourfic" ); ?>
								</span>
                                </div>
                            ...
                            <div class="tf-grid-box tf-visitor-grid-box">
								<?php
								$tf_visitors_details = ! empty( $tf_sorder_details->visitor_details ) ? json_decode( $tf_sorder_details->visitor_details ) : '';
								$traveler_fields     = ! empty( tfopt( 'without-payment-field' ) ) ? $this->tf_data_types( tfopt( 'without-payment-field' ) ) : '';
                        ...
                        <div class="customers-order-date details-box">
                            <h4>
                                ...
                                <div class="others-button">
									<?php
									$tf_qr_download_link = ! empty( $tf_sorder_details->unique_id ) ? $tf_sorder_details->unique_id : '';
                            ...
                            <div class="tf-grid-box">
                                ...
                                <div class="tf-grid-single">
									...
									$tour_ides = ! empty( $tf_sorder_details->unique_id ) ? $tf_sorder_details->unique_id : '';
									// Address
									$location = '';
									if ( ! empty( $meta['location'] ) && $this->tf_data_types( $meta['location'] ) ) {
										$location = ! empty( $this->tf_data_types( $meta['location'] )['address'] ) ? $this->tf_data_types( $meta['location'] )['address'] : $location;
									}
									// Tour Date
									$tour_date = $tf_sorder_details->tour_date;
									if ( $tour_date ) {
									...
									$tour_time     = ! empty( $tf_sorder_details->tour_time ) ? $tf_sorder_details->tour_time : '';
                                            ...
                                            <div class="tf-visitor-vouchers" style="background-image: url(<?php echo esc_url( $tf_qr_watermark ); ?>);">
                                                ...
                                                <div class="tf-voucher-qr-code">
                                                    ...
                                                    <img style="border: 1px solid #ccc;"
                                                         src="//chart.apis.google.com/chart?cht=qr&chs=<?php echo $width; ?>x<?php echo $height; ?>&chl=<?php echo htmlspecialchars( $uri ); ?>&choe=UTF-8"
                                                ...
                                                <div class="tf-voucher-billing-info">
                                                    <div class="tf-billing-details">
                                                        ...
                                                        <h5><?php _e( "Price:", "tourfic" ); ?><?php echo wc_price( $tf_sorder_details->total_price ) ?></h5>
														<?php if ( ! empty( $tf_sorder_details->due_price ) ) { ?>
                                                            <h5><?php _e( "Due Price:", "tourfic" ); ?><?php echo wc_price( $tf_sorder_details->due_price ) ?></h5>
														<?php } ?>
                                ...
                                <div class="traveller-info">
									...
									if ( empty( $traveler_fields ) ) { ?>
                                        <div class="traveller-single-info">
                                            ...
                                            <input type="text" name="traveller[<?php echo esc_attr( $traveller_in ); ?>][tf_full_name]" id="tf_full_name<?php echo esc_attr( $traveller_in ); ?>" data-required="1"
                                                   value="<?php echo ! empty( $tf_visitors_details->{$traveller_in}->{'tf_full_name'} ) ? esc_attr( $tf_visitors_details->{$traveller_in}->{'tf_full_name'} ) : '' ?>"/>

                                        </div>
                                        <div class="traveller-single-info">
                                            <label for="tf_dob<?php echo esc_attr( $traveller_in ); ?>"><?php _e( 'Date of birth', 'tourfic' ); ?></label>
                                            <input type="date" name="traveller[<?php echo esc_attr( $traveller_in ); ?>][tf_dob]" id="tf_dob<?php echo esc_attr( $traveller_in ); ?>" data-required="1"
                                        ...
                                        <div class="traveller-single-info">
                                            ...
                                            <input type="text" name="traveller[<?php echo esc_attr( $traveller_in ); ?>][tf_nid]" id="tf_nid<?php echo esc_attr( $traveller_in ); ?>" data-required="1"
                                                   value="<?php echo ! empty( $tf_visitors_details->{$traveller_in}->{'tf_nid'} ) ? esc_attr( $tf_visitors_details->{$traveller_in}->{'tf_nid'} ) : '' ?>"/>
										...
										foreach ( $traveler_fields as $field ) {
											if ( "text" == $field['reg-fields-type'] || "email" == $field['reg-fields-type'] || "date" == $field['reg-fields-type'] ) {
                                                ...
                                                <div class="traveller-single-info">
                                                    ...
                                                    <input type="<?php echo $field['reg-fields-type']; ?>" name="traveller[<?php echo $traveller_in; ?>][<?php echo $field['reg-field-name']; ?>]"
                                                           id="<?php echo $field['reg-field-name'] . $traveller_in; ?>"
													...
													foreach ( $field['reg-options'] as $sfield ) {
														if ( ! empty( $sfield['option-label'] ) && ! empty( $sfield['option-value'] ) ) {
                                                            ...
                                                            <div class="tf-single-checkbox">
                                                                <input type="<?php echo esc_attr( $field['reg-fields-type'] ); ?>" name="traveller[<?php echo $traveller_in; ?>][<?php echo $field['reg-field-name']; ?>][]"
                                                                       id="<?php echo $sfield['option-value'] . $traveller_in; ?>"
                                                                       value="<?php echo $sfield['option-value']; ?>" <?php echo in_array( $sfield['option-value'], $tf_fields_values ) ? esc_attr( 'checked' ) : ''; ?> />
                ...
                <div class="voucher-quick-view">
                    ...
                    <div class="tf-visitor-vouchers" style="background-image: url(<?php echo esc_url( $tf_qr_watermark ); ?>);">
                        ...
                        <div class="tf-voucher-qr-code">
                            ...
                            <img style="border: 1px solid #ccc;" src="//chart.apis.google.com/chart?cht=qr&chs=<?php echo $width; ?>x<?php echo $height; ?>&chl=<?php echo htmlspecialchars( $uri ); ?>&choe=UTF-8"
                                 alt="<?php echo htmlspecialchars( $title ); ?>"/>
                        </div>
                        <div class="tf-voucher-billing-info">
                            <div class="tf-billing-details">
