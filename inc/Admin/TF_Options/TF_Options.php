	...
	class TF_Options {
		...
		public function tf_options_admin_enqueue_scripts( $screen ) {
			...
			if ( in_array( $screen, $tf_options_screens ) || in_array( $post_type, $tf_options_post_type ) ) {
				wp_enqueue_style( 'tf-admin', TF_ADMIN_ASSETS_URL . 'css/tourfic-admin.min.css', '', TF_VERSION );
			...
			if ( in_array( $screen, $tf_options_screens ) || in_array( $post_type, $tf_options_post_type ) ) {
				...
				wp_enqueue_script( 'tf-fullcalender', TF_ADMIN_ASSETS_URL . 'js/lib/fullcalender.min.js', array( 'jquery' ), TF_VERSION, true );
				
				wp_enqueue_script( 'tf-admin', TF_ADMIN_ASSETS_URL . 'js/tourfic-admin-scripts.min.js', array( 'jquery', 'wp-data', 'wp-editor', 'wp-edit-post' ), TF_VERSION, true );
