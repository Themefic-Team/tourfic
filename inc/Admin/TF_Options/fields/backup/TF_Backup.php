...
if ( ! class_exists( 'TF_Backup' ) ) {
    class TF_Backup extends TF_Fields {
        ...
        public function render() {
	        ...
	        echo '<div class="tf-field-notice-inner tf-notice-warning" style="display: inline-block">'.esc_html__('Note: Exporting full data may take time depending on the data size. Please be patient and do not close the browser until the process is complete. Your data size is: ', 'tourfic').'<strong>'.$data_size.'</strong></div>';
        }
    }
}