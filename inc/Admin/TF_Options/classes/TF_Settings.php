...
if ( ! class_exists( 'TF_Settings' ) ) {
	class TF_Settings {
		...
		<div class="tf-setting-top-bar">
			<div class="version">
				<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tourfic-logo.webp" alt="logo">
			...
			<div class="tf-setting-dashboard">
				...
				<div class="tf-setting-banner">
					<div class="tf-setting-banner-content">
						<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tourfic-logo-white.png" alt="logo">
						<span>Build & Manage Your Next <b>Travel or Hotel Booking Website</b>with Tourfic</span>
					</div>
					<div class="tf-setting-banner-image">
						<img src="<?php echo TF_APP_ASSETS_URL; ?>images/hotel-booking-management-system@2x.webp" alt="Banner Image">
					</div>
				</div>
				<!-- dashboard-banner-section -->
				...
				<div class="tf-setting-performace-section">
					...
					<div class="tf-performance-grid">
						<div class="tf-single-performance-grid">
							...
							<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-hotel.png" alt="total Hotel">
							</div>
						...
						<div class="tf-single-performance-grid">
							<div class="tf-single-performance-icon">
							<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-tours.png" alt="total Tours">
							</div>
							<div class="tf-single-performance-content">
                        ...
                        <div class="tf-single-performance-grid">
                            <div class="tf-single-performance-icon">
                                <img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-apartment.png" alt="total apartment">
                            </div>
                            <div class="tf-single-performance-content">
						...
						<div class="tf-single-performance-grid">
							<div class="tf-single-performance-icon">
							<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-booking-online.png" alt="total Booking">
							</div>
							<div class="tf-single-performance-content">
						...
						<div class="tf-single-performance-grid">
							<div class="tf-single-performance-icon">
							<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-add-user.png" alt="total Customer">
							</div>
							<div class="tf-single-performance-content">
			...
			<div class="tf-settings-help-center">
				<div class="tf-help-center-banner">
					...
					<div class="tf-help-center-image">
						<img src="<?php echo TF_APP_ASSETS_URL; ?>images/setup_wizard.png" alt="setup wizard">
					</div>
				</div>
                ...
                <div class="tf-help-center-banner">
                    ...
                    <div class="tf-help-center-image">
                        <img src="<?php echo TF_APP_ASSETS_URL; ?>images/help-center.jpg" alt="HELP Center Image">
                    </div>
                </div>
				...
				<div class="tf-support-document">
					<div class="tf-single-support">
						<a href="https://themefic.com/docs/tourfic/" target="_blank">
							<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-documents.png" alt="Document">
					...
					<div class="tf-single-support">
						<a href="https://portal.themefic.com/support/" target="_blank">
							<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-mail.png" alt="Document">
					...
					<div class="tf-single-support">
						<a href="https://themefic.com/tourfic/" target="_blank">
							<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-comment.png" alt="Document">
					...
					<div class="tf-single-support">
						<a href="https://www.youtube.com/playlist?list=PLY0rtvOwg0ylCl7NTwNHUPq-eY1qwUH_N" target="_blank">
							<img src="<?php echo TF_APP_ASSETS_URL; ?>images/tf-tutorial.png" alt="Document">
