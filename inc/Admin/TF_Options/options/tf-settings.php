						...
						array(
							...
							'fields' => array(
								...
								array(
									...
									'subtitle'   => __( 'You have the option to override this from the settings specific to each individual car page.', 'tourfic' ),
									'options'  => array(
										'design-1' => array(
											'title' => esc_html__('Design 1', 'tourfic'),
								...
								array(
									...
									'subtitle' => __( 'Upload Banner Image for this car archive template.', 'tourfic' ),
									'library' => 'image',
