		...
		'payment_popup' => array(
			...
			'fields' => array(
				array(
					...
					'type'    => 'heading',
					'title'   => esc_html__( 'Airport Service Popup', 'tourfic' ),
					'content' => esc_html__( 'These labels appear in the booking popup when airport service is enabled for a hotel.', 'tourfic' ),
					'docs'    => esc_url( 'https://themefic.com/docs/tourfic/tourfic-settings/tourfic-hotel-options/#popup' ),
				),
				array(
					'id'      => 'hotel_service_popup_title',
					'type'    => 'text',
					'label'   => esc_html__( 'Airport Service Popup Title', 'tourfic' ),
					'default' => esc_html__( 'Add Service to your Booking.', 'tourfic' ),
				),
				array(
					'id'      => 'hotel_service_popup_subtile',
					'type'    => 'textarea',
					'label'   => esc_html__( 'Airport Service Popup Description', 'tourfic' ),
					'default' => esc_html__( 'Select the services you want to add to your booking.', 'tourfic' ),
				),
				array(
					'id'      => 'hotel_service_popup_action',
					'type'    => 'text',
