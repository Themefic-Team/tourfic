...
TF_Settings::option( 'tf_settings', array(
	...
	'sections' => array(
						...
						array(
							...
							'fields' => array(
								array(
									'id'      => 'car-title',
									'type'    => 'heading',
									'title' => esc_html__( 'Car Single Page', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'       => 'single-car',
								...
								array(
									'id'      => 'car-title',
									'type'    => 'heading',
									'title' => esc_html__( 'Car Archive & Search Result Page', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'       => 'car-archive',
		...
		'single_tour'           => array(
			...
			'fields' => array(
				array(
					...
					'type'     => 'heading',
					'title'    => esc_html__( 'Global Settings for Single Tours Page', 'tourfic' ),
					'content' => esc_html__( 'These options can be overridden from Single Tour Settings.', 'tourfic' ),
		...
		'single_page'           => array(
			...
			'fields' => array(
				array(
					...
					'type'      => 'heading',
					'title'     => esc_html__( 'Global Settings for Single Hotel Page', 'tourfic' ),
					'content' => esc_html__( 'These options can be overridden from Single Hotel Settings.', 'tourfic' ),
		...
		'room_config'=> array(
			...
			'fields' => array(
				array(
					...
					'type'  => 'heading',
					'title' => esc_html__( 'Global Configuration for Hotel Rooms', 'tourfic' ),
		...
		'apartment_single_page' => array(
			...
			'fields' => array(
				array(
					'id'    => 'label_off_heading',
					'type'  => 'heading',
					'title' => esc_html__( 'Single Apartment Settings', 'tourfic' ),
					'content'   => esc_html__( 'These options can be overridden from Single Apartment Settings.', 'tourfic' ),
		...
		'car_single_page' => array(
			...
			'fields' => array(
				array(
					'id'    => 'label_off_heading',
					'type'  => 'heading',
					'title' => esc_html__( 'Single Car Settings', 'tourfic' ),
					'content'   => esc_html__( 'These options can be overridden from Single Car Settings.', 'tourfic' ),
		...
		'car_operating_hours' => array(
			...
			'fields' => array(
				array(
					'id'    => 'label_off_heading',
					'type'  => 'heading',
					'title' => esc_html__( 'Operating Hours Settings', 'tourfic' ),
					'content'   => esc_html__( 'These options can be overridden from Operating Hours Settings.', 'tourfic' ),
					'docs'  => esc_url('https://themefic.com/docs/tourfic/settings/car-options/#Single_Page_Settings')
				),
		...
		'frontend_dashboard'    => array(
			...
			'fields' => array(
				...
				array(
					'id'           => '',
					'type'         => 'image',
					'label'        => esc_html__( 'Dashboard Logo', 'tourfic' ),
					'library'      => 'image',
					'placeholder'  => 'http://',
				...
				array(
					'id'           => '',
					'type'         => 'image',
					'label'        => esc_html__( 'Minified Logo', 'tourfic' ),
					'library'      => 'image',
					'placeholder'  => 'http://',
					'button_title' => esc_html__( 'Add Image', 'tourfic' ),
					'remove_title' => esc_html__( 'Remove Image', 'tourfic' ),
				...
				array(
					'id'           => '',
					'type'         => 'image',
					'label'        => esc_html__( 'Mobile Logo', 'tourfic' ),
					'library'      => 'image',
					'placeholder'  => 'http://',
					'button_title' => esc_html__( 'Add Image', 'tourfic' ),
					'remove_title' => esc_html__( 'Remove Image', 'tourfic' ),
						...
						array(
							...
							'fields' => array(
								array(
									'id'       => '',
									'type'     => 'checkbox',
									'label'    => esc_html__( 'Vendor Can Add Post', 'tourfic' ),
									'subtitle' => esc_html__( 'Choose the post type you wish to enable for vendor contributions.', 'tourfic' ),
									'is_pro'      => true,
									'options'  => array(
								...
								array(
									'id'       => '',
									'type'     => 'checkbox',
									'label'    => esc_html__( 'Vendor Can Add Taxonomy', 'tourfic' ),
									'subtitle' => esc_html__( 'Choose the Taxonomy you wish to enable for vendor contributions.', 'tourfic' ),
									'is_pro'      => true,
									'options'  => array(
										'hotel_location'     => esc_html__( 'Hotel Location', 'tourfic' ),
										'hotel_feature'      => esc_html__( 'Hotel Feature', 'tourfic' ),
										'hotel_type'         => esc_html__( 'Hotel Type', 'tourfic' ),
										'tour_destination'   => esc_html__( 'Tour Destination', 'tourfic' ),
										'tour_attraction'    => esc_html__( 'Tour Attraction', 'tourfic' ),
										'tour_activities'    => esc_html__( 'Tour Activities', 'tourfic' ),
										'tour_features'      => esc_html__( 'Tour Features', 'tourfic' ),
										'tour_type'          => esc_html__( 'Tour Types', 'tourfic' ),
										'apartment_location' => esc_html__( 'Apartment Location', 'tourfic' ),
										'apartment_feature'  => esc_html__( 'Apartment Feature', 'tourfic' ),
										'apartment_type'     => esc_html__( 'Apartment Types', 'tourfic' ),
									),
								),
								array(
									'id'       => '',
									'type'     => 'checkbox',
									'label'    => esc_html__( 'Vendor Can Manage Options', 'tourfic' ),
									'subtitle' => esc_html__( 'Choose the capabilities you wish to grant vendors for management.', 'tourfic' ),
									'is_pro'      => true,
									'options'  => array(
										'view_hotel_enquiry'     => esc_html__( 'View Hotel Enquiry', 'tourfic' ),
										'view_hotel_booking'     => esc_html__( 'View Hotel Booking', 'tourfic' ),
										'add_hotel_booking'      => esc_html__( 'Add Hotel Booking', 'tourfic' ),
										'view_tour_enquiry'      => esc_html__( 'View Tour Enquiry', 'tourfic' ),
										'view_tour_booking'      => esc_html__( 'View Tour Booking', 'tourfic' ),
										'add_tour_booking'       => esc_html__( 'Add Tour Booking', 'tourfic' ),
										'view_apartment_enquiry' => esc_html__( 'View Apartment Enquiry', 'tourfic' ),
										'view_apartment_booking' => esc_html__( 'View Apartment Booking', 'tourfic' ),
										'view_commission'        => esc_html__( 'View Commission', 'tourfic' ),
										'view_payout'            => esc_html__( 'View Payout', 'tourfic' ),
						...
						array(
							...
							'fields' => array(
								array(
									'id'       => '',
									'type'     => 'checkbox',
									'label'    => esc_html__( 'Manager Can Add Post', 'tourfic' ),
									'subtitle' => esc_html__( "Choose the post type you wish to enable for your Manager's contributions.", 'tourfic' ),
									'is_pro'      => true,
									'options'  => array(
										'hotel'     => esc_html__( 'Hotel', 'tourfic' ),
										'tour'      => esc_html__( 'Tour', 'tourfic' ),
								...
								array(
									'id'       => '',
									'type'     => 'checkbox',
									'label'    => esc_html__( 'Manager Can Add Taxonomy', 'tourfic' ),
									'subtitle' => esc_html__( "Choose the Taxonomy you wish to enable for your Manager's contributions.", 'tourfic' ),
									'is_pro'      => true,
									'options'  => array(
										'hotel_location'     => esc_html__( 'Hotel Location', 'tourfic' ),
										'hotel_feature'      => esc_html__( 'Hotel Feature', 'tourfic' ),
								...
								array(
									'id'       => '',
									'type'     => 'checkbox',
									'label'    => esc_html__( 'Manager Can Manage Options', 'tourfic' ),
									'subtitle' => esc_html__( "Choose the Options you wish to enable for your Manager's contributions.", 'tourfic' ),
									'is_pro'      => true,
									'options'  => array(
										'view_hotels'            => esc_html__( 'View Hotels', 'tourfic' ),
										'approve_hotel'          => esc_html__( 'Approve Hotel', 'tourfic' ),
										'add_hotel'              => esc_html__( 'Add Hotel', 'tourfic' ),
										'edit_hotel'             => esc_html__( 'Edit Hotel', 'tourfic' ),
										'delete_hotel'           => esc_html__( 'Delete Hotel', 'tourfic' ),
										'view_tours'             => esc_html__( 'View Tours', 'tourfic' ),
										'approve_tour'           => esc_html__( 'Approve Tour', 'tourfic' ),
										'add_tour'               => esc_html__( 'Add Tour', 'tourfic' ),
										'edit_tour'              => esc_html__( 'Edit Tour', 'tourfic' ),
										'delete_tour'            => esc_html__( 'Delete Tour', 'tourfic' ),
										'approve_apartment'      => esc_html__( 'Approve Apartment', 'tourfic' ),
										'add_apartment'          => esc_html__( 'Add Apartment', 'tourfic' ),
										'edit_apartment'         => esc_html__( 'Edit Apartment', 'tourfic' ),
										'delete_apartment'       => esc_html__( 'Delete Apartment', 'tourfic' ),
										'view_vendors'           => esc_html__( 'View Vendors', 'tourfic' ),
										'approve_vendor'         => esc_html__( 'Approve Vendor', 'tourfic' ),
										'add_vendor'             => esc_html__( 'Add Vendor', 'tourfic' ),
										'edit_vendor'            => esc_html__( 'Edit Vendor', 'tourfic' ),
										'delete_vendor'          => esc_html__( 'Delete Vendor', 'tourfic' ),
										'approve_payout'         => esc_html__( 'Approve Payout', 'tourfic' ),
										'add_payout'             => esc_html__( 'Add Payout', 'tourfic' ),
										'edit_payout'            => esc_html__( 'Edit Payout', 'tourfic' ),
										'view_hotel_enquiry'     => esc_html__( 'View Hotel Enquiry', 'tourfic' ),
										'view_hotel_booking'     => esc_html__( 'View Hotel Booking', 'tourfic' ),
										'add_hotel_booking'      => esc_html__( 'Add Hotel Booking', 'tourfic' ),
										'view_tour_enquiry'      => esc_html__( 'View Tour Enquiry', 'tourfic' ),
			...
			'fields' => array(
				array(
					...
					'tabs' => array(
						array(
							'id'     => 'general-setting',
							'title'  => esc_html__('General Options', 'tourfic'),
							'icon'   => 'fa fa-gear',
							'fields' => array(
								array(
									'id'       => 'vendor-reg',
									'type'     => 'switch',
									'label'    => esc_html__( 'Enable Vendor Registration', 'tourfic' ),
									'subtitle' => esc_html__( 'Visitor can register as vendor using the registration form', 'tourfic' ),
									'is_pro'   => true,
								),
								array(
									'id'       => 'user_approval',
									'type'     => 'switch',
									'label'    => esc_html__( 'Automatic Approval', 'tourfic' ),
									'subtitle' => esc_html__( 'Partner be automatic approval (register account).', 'tourfic' ),
									'is_pro'   => true,
								),
								/*array(
									'id'        => 'reg-pop',
								...
								array(
									'id'       => 'email-verify',
									'type'     => 'switch',
									'label'    => esc_html__( 'Email Verification', 'tourfic' ),
									'subtitle' => esc_html__( 'ON: Vendor must verify by email', 'tourfic' ),
									'is_pro'   => true,
								),
								array(
									'id'       => 'partner_post',
									'type'     => 'switch',
									'label'    => esc_html__( "Partner's Post Must be Approved by Admin", 'tourfic' ),
									'subtitle' => esc_html__( 'ON: When partner posts a service, it needs to be approved by administrator ', 'tourfic' ),
									'is_pro'   => true,
								),
								array(
									'id'      => 'notice_shortcode',
								...
								array(
									...
									'type'       => 'number',
									'label'      => esc_html__( 'Commission(%)', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter commission of partner for admin after each item is booked ', 'tourfic' ),
									'attributes' => array(
										'min' => '0',
									),
									'is_pro'     => true,
								...
								array(
									'id'      => 'pabbly-title',
									'type'    => 'heading',
									'title' => esc_html__( 'Pabbly', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'        => 'vendor-integrate-pabbly',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for New Vendor Registration?', 'tourfic' ),
									'subtitle'  => esc_html__( 'You can able to Integrate Pabbly with New Vendor Registration.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Vendor Registration Web Hook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Here Your Vendor Registration Pabbly Web Hook.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'      => 'zapier-title',
									'type'    => 'heading',
									'title' => esc_html__( 'Zapier', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'        => 'vendor-integrate-zapier',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for New Vendor Registration?', 'tourfic' ),
									'subtitle'  => esc_html__( 'You can able to Integrate Zapier with New Vendor Registration.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Vendor Registration Web Hook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Here Your Vendor Registration Zapier Web Hook.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
						...
						array(
							'id'     => 'layout-setting',
							'title'  => esc_html__('Vendor Dashboard', 'tourfic'),
							'icon'   => 'fa fa-gear',
							'fields' => array(
								array(
									'id'       => 'vendor-config',
									'type'     => 'switch',
									'label'    => esc_html__( 'Configuration Partner Profile info', 'tourfic' ),
									'subtitle' => esc_html__( 'Show/hide sections for partner dashboard', 'tourfic' ),
									'is_pro'   => true,
								),
								array(
									'id'       => 'vendor-earning',
									'type'     => 'switch',
									'label'    => esc_html__( 'Show total Earning', 'tourfic' ),
									'subtitle' => esc_html__( 'ON: Display earnings information in accordance with time periods', 'tourfic' ),
									'is_pro'   => true,
								),
								array(
									'id'       => 'vendor-each-earning',
									'type'     => 'switch',
									'label'    => esc_html__( 'Show each service Earning', 'tourfic' ),
									'subtitle' => esc_html__( 'ON: Display earnings according to each service', 'tourfic' ),
									'is_pro'   => true,
								),
								array(
									'id'       => 'vendor-earning-chart',
									'type'     => 'switch',
									'label'    => esc_html__( 'Show Chart info', 'tourfic' ),
									'subtitle' => esc_html__( 'ON: Display visual graphs to follow your earnings through each time', 'tourfic' ),
									'is_pro'   => true,
								),
							),
						),
						array(
							'id'     => 'withdraw-setting',
							'title'  => esc_html__('Withdrawal Options', 'tourfic'),
							'icon'   => 'fa fa-gear',
							'fields' => array(
								array(
									'id'       => 'vendor-withdraw',
									'type'     => 'switch',
									'label'    => esc_html__( 'Allow Request Withdrawal', 'tourfic' ),
									'subtitle' => esc_html__( 'ON: Partner is allowed to withdraw money', 'tourfic' ),
									'is_pro'   => true,
								),
								array(
									'id'         => 'vendor_min_withdraw',
									'type'       => 'number',
									'label'      => esc_html__( 'Minimum value request when withdrawal', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter minimum value when a withdrawal is conducted', 'tourfic' ),
									'attributes' => array(
										'min' => '0',
									),
									'is_pro'     => true,
								...
								array(
									...
									'type'       => 'number',
									'label'      => esc_html__( 'Date of sucessful payment in current month', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter the date monthly payment. Ex: 25', 'tourfic' ),
									'attributes' => array(
										'min' => '1',
										'max' => '28',
									),
		...
		'search'                => array(
			...
			'fields' => array(
				array(
					...
					'type'    => 'heading',
					'title' => esc_html__( 'Search Page Settings', 'tourfic' ),
					'content'   => esc_html__( 'These settings apply to the search result page of Hotels/Tours/Apartments.', 'tourfic' ),
					'class'   => 'tf-field-class',
				...
				array(
					...
					'type'     => 'heading',
					'title'    => esc_html__( 'Hotel Search', 'tourfic' ),
				),
				array(
				...
				array(
					...
					'type'     => 'heading',
					'title'    => esc_html__( 'Tour Search', 'tourfic' ),
				),
				array(
					'id'        => 'date_tour_search',
					'type'      => 'switch',
				...
				array(
					...
					'type'     => 'heading',
					'title'    => esc_html__( 'Apartment Search', 'tourfic' ),
				),
				array(
				...
				array(
					...
					'type'     => 'heading',
					'title'    => esc_html__( 'Car Search', 'tourfic' ),
				),
				array(
						...
						array(
							...
							'fields' => array(
								array(
									...
									'label'      => esc_html__( 'Login Page', 'tourfic' ),
									'subtitle'   => esc_html__( 'Choose a page to serve as the Login Page.', 'tourfic' ),
								...
								array(
									'id'          => '',
									'type'        => 'select',
									'label'       => esc_html__( 'Login Redirect Option', 'tourfic' ),
									'subtitle'    => esc_html__( 'Select the destination for users after they log in.', 'tourfic' ),
									'options'     => array(
										'page' => esc_html__( 'Page', 'tourfic' ),
										'url'  => esc_html__( 'Custom URL', 'tourfic' ),
									),
									'field_width' => '50',
									'is_pro'      => true,
								),
								array(
									...
									'label'       => esc_html__( 'Choose your Page', 'tourfic' ),
									'subtitle'    => esc_html__( 'Select the destination page for users after they log in.', 'tourfic' ),
								...
								array(
									'id'          => '',
									'type'        => 'text',
									'label'       => esc_html__( 'Insert Custom URL', 'tourfic' ),
									'subtitle'    => esc_html__( 'Enter the destination URL for users after they log in.', 'tourfic' ),
						...
						array(
							...
							'fields' => array(
								array(
									...
									'label'      => esc_html__( 'Registration Page', 'tourfic' ),
									'subtitle'   => esc_html__( 'Choose a page that will be used as the Registration Page.', 'tourfic' ),
								...
								array(
									'id'          => '',
									'type'        => 'select',
									'label'       => esc_html__( 'Registration Redirect Option', 'tourfic' ),
									'subtitle'    => esc_html__( 'Select the destination for users after they register.', 'tourfic' ),
									'options'     => array(
										'page' => esc_html__( 'Page', 'tourfic' ),
										'url'  => esc_html__( 'Custom URL', 'tourfic' ),
									),
						...
						array(
							...
							'fields' => array(
								array(
									'id'       => '',
									'type'     => 'switch',
									'label'    => esc_html__( 'Setup Google Login', 'tourfic' ),
									'subtitle' => esc_html__( 'If enabled, vendors will have the option to log in using Google.', 'tourfic' ),
									'badge_up' => true,
									'is_pro'   => true,
								),
								array(
									'id'         => '',
									'type'       => 'text',
									'label'      => esc_html__( 'Google App Client ID', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter the App ID', 'tourfic' ),
									'dependency' => array(
								...
								array(
									'id'         => '',
									'type'       => 'text',
									'label'      => esc_html__( 'Google App Client Secret', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter the App Secret', 'tourfic' ),
									'dependency' => array(
										array( 'vendor-google-login', '==', true ),
									),
									'badge_up'   => true,
								...
								array(
									'id'         => '',
									'type'       => 'text',
									'label'      => esc_html__( 'Google Redirect URI', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter the Redirect URI', 'tourfic' ),
									'dependency' => array(
										array( 'vendor-google-login', '==', true ),
									),
									'badge_up'   => true,
						...
						array(
							...
							'fields' => array(
								...
								array(
									...
									'type'         => 'repeater',
									'button_title' => esc_html__( 'Add New', 'tourfic' ),
									'label'        => esc_html__( 'Registration Fields for Vendor', 'tourfic' ),
									'subtitle'     => esc_html__( 'Design custom registration fields for vendor sign-up. Custom fields are permitted.', 'tourfic' ),
									'is_pro'       => true,
									'fields'       => array(
										array(
											'id'    => 'reg-field-label',
										...
										array(
											...
											'subtitle' => esc_html__( 'Space Not allowed (Ex: tf_name)', 'tourfic' ),
											'validate' => 'no_space_no_special',
										),
										array(
											'id'      => 'reg-fields-type',
											'type'    => 'select',
											'label'   => esc_html__( 'Field Type', 'tourfic' ),
											'options' => array(
												'text'     => esc_html__( 'Text', 'tourfic' ),
												'email'    => esc_html__( 'Email', 'tourfic' ),
												'password' => esc_html__( 'Password', 'tourfic' ),
												'textarea' => esc_html__( 'Textarea', 'tourfic' ),
												'radio'    => esc_html__( 'Radio', 'tourfic' ),
												'checkbox' => esc_html__( 'Checkbox', 'tourfic' ),
												'select'   => esc_html__( 'Select', 'tourfic' ),
											),
										),
										array(
											'id'           => 'radio-reg-options',
											'type'         => 'repeater',
											'button_title' => esc_html__( 'Add New Option', 'tourfic' ),
											'label'        => esc_html__( 'Option Label', 'tourfic' ),
											'dependency'   => array(
											...
											'fields'       => array(
												array(
													'label' => esc_html__( 'Field Label', 'tourfic' ),
													'id'    => 'option-label',
													'type'  => 'text',
												),
												array(
													'label' => esc_html__( 'Field Value', 'tourfic' ),
													'id'    => 'option-value',
													'type'  => 'text',
												),
											),
										...
										array(
											...
											'type'  => 'text',
											'label' => esc_html__( 'Placeholder', 'tourfic' ),
										),
										array(
											'id'    => 'reg-field-required',
											'type'  => 'switch',
											'label' => esc_html__( 'Required Field ?', 'tourfic' ),
										),
			...
			'fields' => array(
				...
				array(
					...
					'options'  => array(
						...
						''        => esc_html__( 'Google Map (Pro)', 'tourfic' ),
					),
					'default'  => 'default'
				),
				array(
					'id'          => '',
					'type'        => 'text',
					'label'       => esc_html__( 'Google Map API Key', 'tourfic' ),
					'placeholder' => esc_html__( 'Enter Google Map API Key', 'tourfic' ),
					'dependency'  => array(
		...
		'wishlist'              => array(
			...
			'fields' => array(
				array(
					'id'      => 'wishlist_heading',
					'type'    => 'heading',
					'title' => esc_html__( 'Wishlist Settings', 'tourfic' ),
					'content' => esc_html__( 'The wishlist feature enables customers to curate a collection of hotels, tours, and apartments they are interested in or plan to book in the future.', 'tourfic' ),
		...
		'permalink' => array(
			...
			'fields' => array(
				array(
					...
					'type'    => 'heading',
					'title' => esc_html__( 'Permalink Settings', 'tourfic' ),
					'content' => esc_html__( 'Select the URL structure for your Hotels, Tours, and Apartments listings.', 'tourfic' ),
		...
		'review'       => array(
			...
			'fields' => array(
				array(
					'id'      => 'review_heading',
					'type'    => 'heading',
					'title' => esc_html__( 'Review Settings', 'tourfic' ),
					'content' => esc_html__( 'Configure your Hotel/Tour/Apartment Customer Review Section through this settings panel.', 'tourfic' ),
				...
				array(
					...
					'options' => array(
						'li' => esc_html__( 'Logged in User', 'tourfic' ),
						''   => esc_html__( 'Logged out User (Pro)', 'tourfic' ),
					),
					'default' => array( 'li' ),
				),
		...
		'optimization' => array(
			...
			'fields' => array(
				array(
					...
					'type'    => 'heading',
					'title' => esc_html__( 'Minification Settings', 'tourfic' ),
					'content'  => esc_html__( "Enhance your website's performance by activating the minification for the files listed below. After enabling each setting, please conduct a thorough test of your site to ensure that these changes do not negatively impact your website's functionality.", 'tourfic' ),
		 ...
		 */
		'affiliate' => array(
			'title'  => esc_html__( 'Affiliate', 'tourfic' ),
			'parent' => 'pro_options',
			...
			'fields' => array(
				array(
					...
					'type'     => 'heading',
					'title'    => esc_html__( 'Affiliate Settings', 'tourfic' ),
					'content' => esc_html__( 'Use these options if you want to show 3rd party data and earn commission from them. Currently, we only allow Booking.com and TravelPayout. Gradually more options would be added.', 'tourfic' ),
				),
				array(
					'id'       => 'tf-affiliate',
					'type'     => 'callback',
						...
						array(
							...
							'fields' => array(
								...
								array(
									...
									'type'  => 'heading',
									'title' => esc_html__( 'Admin Email Setting', 'tourfic' ),
								),
								array(
		...
		'qr_code' => array(
			...
			'fields' => array(
				array(
					'id'      => 'qr-code-title',
					'type'    => 'heading',
					'title'    => esc_html__( 'Tour QR Code', 'tourfic' ),
					'content' => esc_html__( 'Configure the QR code generation for your tours here. This will allow for the creation of unique QR codes that can be scanned for tour information or check-ins.', 'tourfic' ),
					'class'   => 'tf-field-class',
				...
				array(
					'id'    => 'qr_logo',
					'type'  => 'image',
					'label' => esc_html__( 'Company Logo', 'tourfic' ),
					'is_pro' => true,
				),
				array(
					'id'    => 'qr_background',
					'type'  => 'image',
					'label' => esc_html__( 'QR Code Watermark', 'tourfic' ),
					'is_pro' => true,
				),
				array(
					'id'      => 'qr-ticket-title',
					'type'    => 'text',
					'label'   => esc_html__( 'Voucher Title', 'tourfic' ),
					'default' => "Voucher ID",
					'is_pro'  => true,
				),
				array(
					'id'     => 'qr-ticket-prefix',
					'type'   => 'text',
					'label'  => esc_html__( 'Voucher ID Prefix', 'tourfic' ),
					'is_pro' => true,
				),
				array(
					'id'      => 'qr-ticket-content',
					'type'    => 'text',
					'label'   => esc_html__( 'Voucher Policy', 'tourfic' ),
				...
				array(
					'id'      => 'qr-ticket-verify',
					'type'    => 'select',
					'label'   => esc_html__( 'QR Code Verification', 'tourfic' ),
					'options' => array(
						'1' => esc_html__( '1 Step', 'tourfic' ),
						'2' => esc_html__( '2 Steps', 'tourfic' ),
					),
					'default' => '2',
					'is_pro'  => true,
				),
		...
		'integration' => array(
			'title'  => esc_html__( 'Integration', 'tourfic' ),
			'parent' => 'pro_options',
			'icon'   => 'fa fa-plus',
			'fields' => array(
				array(
					...
					'type'     => 'heading',
					'title'    => esc_html__( 'Tourfic Integration Settings', 'tourfic' ),
					'content' => esc_html__( 'For integration with other systems, we currently support connections via Pabbly, Zapier and Google Calendar only.', 'tourfic' ),
				),
				array(
					'id'     => 'tf-integration',
					'type'   => 'tab',
					...
					'tabs'   => array(
						array(
							...
							'title'  => esc_html__( 'Pabbly Setup', 'tourfic' ),
							'fields' => array(
								array(
									'id'      => 'hotel-title',
									'type'    => 'heading',
									'title' => esc_html__( 'Hotel Integration', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'        => 'hotel-integrate-pabbly',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for Hotel?', 'tourfic' ),
									'subtitle'  => esc_html__( 'You have the ability to integrate Pabbly with the creation and updating of hotels in our system.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Hotel Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Pabbly Webhook for Hotels.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'        => 'h-enquiry-pabbly',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for Hotel Enquiry Form?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Pabbly with Hotel Enquiry Form.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Hotel Enquiry Form Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Pabbly Webhook for Hotel Enquiry Form.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'      => 'tour-title',
									'type'    => 'heading',
									'title' => esc_html__( 'Tour Integration', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'        => 'tour-integrate-pabbly',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for Tour?', 'tourfic' ),
									'subtitle'  => esc_html__( 'You have the ability to integrate Pabbly with the creation and updating of tours in our system.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Tour Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Pabbly Webhook for Tour.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'        => 't-enquiry-pabbly',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for Tour Enquiry Form?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Pabbly with Tour Enquiry Form.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Tour Enquiry Form Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Pabbly Webhook for Tour Enquiry Form.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'      => 'apartment-title',
									'type'    => 'heading',
									'title' => esc_html__( 'Apartment Integration', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'        => 'apartment-integrate-pabbly',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for Apartment?', 'tourfic' ),
									'subtitle'  => esc_html__( 'You have the ability to integrate Pabbly with the creation and updating of apartments in our system.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Apartment Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Pabbly Webhook for Apartment.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'        => 'a-enquiry-pabbly',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for Apartment Enquiry Form?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Pabbly with Apartment Enquiry Form.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Apartment Enquiry Form Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Pabbly Webhook for Apartment Enquiry Form.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									...
									'type'    => 'heading',
									'title' => esc_html__( 'WooCommerce Integration', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'        => 'tf-new-order-pabbly',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for Booking?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Pabbly with WooCommerce Booking.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Booking Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Pabbly Webhook for Booking.', 'tourfic' ),
									'dependency' => array(
								...
								array(
									...
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Pabbly for New Customer?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Pabbly with WooCommerce New Customer.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'New Customer Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Pabbly Webhook for New Customer.', 'tourfic' ),
									'dependency' => array(
						...
						array(
							...
							'title'  => esc_html__( 'Zapier Setup', 'tourfic' ),
							'icon'   => 'fa fa-gear',
							'fields' => array(
								array(
								...
								array(
									...
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for Hotel?', 'tourfic' ),
									'subtitle'  => esc_html__( 'You have the ability to integrate Zapier with the creation and updating of hotels in our system.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Hotel Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Zapier Webhook for Hotels.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'        => 'h-enquiry-zapier',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for Hotel Enquiry Form?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Zapier with Hotel Enquiry Form.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Hotel Enquiry Form Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Zapier Webhook for Hotel Enquiry Form.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									...
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for Tour?', 'tourfic' ),
									'subtitle'  => esc_html__( 'You have the ability to integrate Zapier with the creation and updating of tours in our system.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Tour Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Zapier Webhook for Tours.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'        => 't-enquiry-zapier',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for Tour Enquiry Form?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Zapier with Tour Enquiry Form.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Tour Enquiry Form Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Zapier Webhook for Tour Enquiry Form.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									...
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for Apartment?', 'tourfic' ),
									'subtitle'  => esc_html__( 'You have the ability to integrate Zapier with the creation and updating of apartments in our system.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Apartment Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Zapier Webhook for Apartment.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									'id'        => 'a-enquiry-zapier',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for Apartment Enquiry Form?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Zapier with Apartment Enquiry Form.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Apartment Enquiry Form Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Zapier Webhook for Apartment Enquiry Form.', 'tourfic' ),
									'is_pro'     => true,
									'dependency' => array(
								...
								array(
									...
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for Booking?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Zapier with WooCommerce Booking.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Booking Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Zapier Webhook for Booking.', 'tourfic' ),
									'dependency' => array(
								...
								array(
									...
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Zapier for New Customer?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Zapier with WooCommerce New Customer.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'New Customer Webhook', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Zapier Webhook for New Customer.', 'tourfic' ),
									'dependency' => array(
						...
						array(
							...
							'title'  => esc_html__( 'Google Calendar Setup', 'tourfic' ),
							'icon'   => 'fa fa-gear',
							'fields' => array(
								array(
								...
								array(
									'id'      => 'woocommerce-title',
									'type'    => 'heading',
									'title' => esc_html__( 'Google Calendar Integration', 'tourfic' ),
									'class'   => 'tf-field-class',
								),
								array(
									'id'        => 'tf-new-order-google-calendar',
									'type'      => 'switch',
									'label'     => esc_html__( 'Enable Google Calendar for Booking?', 'tourfic' ),
									'subtitle'  => esc_html__( 'Connect Google Calendar with WooCommerce Booking.', 'tourfic' ),
									'label_on'  => esc_html__( 'Yes', 'tourfic' ),
									'label_off' => esc_html__( 'No', 'tourfic' ),
									'default'   => false,
									'is_pro'    => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Client Id', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Google Calendar Client Id for Booking.', 'tourfic' ),
									'dependency' => array(
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Secret Key', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Google Calendar Secret Key for Booking.', 'tourfic' ),
									'dependency' => array(
										array( 'tf-new-order-google-calendar', '==', 'true' ),
									),
									'is_pro'     => true,
								...
								array(
									...
									'type'       => 'text',
									'label'      => esc_html__( 'Redirect Url', 'tourfic' ),
									'subtitle'   => esc_html__( 'Enter Your Google Calendar Redirect Url for Booking.', 'tourfic' ),
									'dependency' => array(
										array( 'tf-new-order-google-calendar', '==', 'true' ),
									),
									'is_pro'     => true,
		...
		// Pro Options
		'pro_options' => array(
			'title'  => esc_html__( 'Pro Options', 'tourfic' ),
			'icon'   => 'fa-solid fa-atom',
			'fields' => array(),
		),
		// Itinerary Settings
		'tour_itinerary-pro'        => array(
			'title'  => esc_html__( 'Tour Itinerary Settings', 'tourfic' ),
			'parent' => 'pro_options',
			'icon'   => 'fa fa-cog',
			'fields' => array(
				array(
						...
						array(
							...
							'fields' => array(
								array(
									...
									'type'     => 'heading',
									'content' => esc_html__( 'You can create your own Itinerary using Tourfic\'s Itinerary builder. The builder can be found on Single Tour Settings', 'tourfic' ),
								),
								array(
									'id'           => '',
									'type'         => 'repeater',
									'label'        => esc_html__( 'Create Custom Itinerary options', 'tourfic' ),
									'button_title' => esc_html__( 'Add New Options', 'tourfic' ),
									'is_pro'       => true,
									'fields'       => array(
										array(
											'id'    => 'sleep-mode-title',
											'type'  => 'text',
											'label' => esc_html__( 'Field Title', 'tourfic' ),
										),
										array(
											'id'    => 'sleep-mode-icon',
											'type'  => 'icon',
											'label' => esc_html__( 'Field Icon', 'tourfic' ),
										),
									),
								),
								array(
									'id'           => '',
									'type'         => 'repeater',
									'button_title' => esc_html__( 'Add New Meal', 'tourfic' ),
									'label'        => esc_html__( 'Include Meal', 'tourfic' ),
									'is_pro'       => true,
									'fields'       => array(
										array(
											'id'    => 'meal',
											'type'  => 'text',
											'label' => esc_html__( 'Meal name', 'tourfic' ),
										),
									),
								),
								array(
									'id'      => '',
									'label'   => esc_html__( 'Elevation Input', 'tourfic' ),
									'type'    => 'select',
									'options' => [
										'Meter' => esc_html__( 'Meter', 'tourfic' ),
										'Feet'  => esc_html__( 'Feet', 'tourfic' ),
									],
									'is_pro'  => true,
									'default' => 'Meter',
								),
								array(
									...
									'type'        => 'switch',
									'is_pro'      => true,
									'label'       => esc_html__( 'Show Chart on Trip Page', 'tourfic' ),
									'field_width' => 50,
								),
								array(
									'id'          => '',
									'type'        => 'switch',
									'is_pro'      => true,
									'label'       => esc_html__( 'Always Show All Itinerary', 'tourfic' ),
									'field_width' => 50,
								),
								array(
									'id'          => '',
									'type'        => 'switch',
									'is_pro'      => true,
									'label'       => esc_html__( 'Show X-Axis', 'tourfic' ),
									'field_width' => 50,
								),
								array(
									'id'          => '',
									'type'        => 'switch',
									'is_pro'      => true,
									'label'       => esc_html__( 'Show Y-Axis', 'tourfic' ),
									'field_width' => 50,
								),
								array(
									'id'          => '',
									'type'        => 'switch',
									'is_pro'      => true,
									'label'       => esc_html__( 'Show line Graph', 'tourfic' ),
									'field_width' => 50,
								),
							),
						),
						array(
							...
							'fields' => array(
								array(
									...
									'type'     => 'switch',
									'is_pro'   => true,
									'label'    => esc_html__( 'Enable Itinerary Downloader', 'tourfic' ),
									'subtitle' => esc_html__( 'Turn this on to give customers the option to download the itinerary plan as a PDF.', 'tourfic' ),
									"default" => true,
								),
								array(
									'id'      => 'tour_pdf_downloader_section',
									'type'    => 'heading',
									'title' => esc_html__( 'Tour Itinerary Downloader Section', 'tourfic' ),
								),
								array(
									'id'    => '',
									'type'  => 'text',
									'label' => esc_html__( 'Itinerary Downloader Title', 'tourfic' ),
								...
								array(
									'id'    => '',
									'type'  => 'text',
									'label' => esc_html__( 'Itinerary Downloader Description', 'tourfic' ),
								...
								array(
									'id'    => '',
									'type'  => 'text',
									'label' => esc_html__( 'Itinerary Downloader Button Text', 'tourfic' ),
								...
								array(
									'id'          => '',
									'type'        => 'number',
									'label'       => esc_html__( 'Image Thumbnail Width', 'tourfic' ),
								...
								array(
									...
									'type'    => 'heading',
									'title' => esc_html__( 'Default Company Info in PDF', 'tourfic' ),
								),
								array(
									'id'      => 'tour-option-notice-one',
									'type'    => 'notice',
									'content' => esc_html__( 'If no company information is specified in the Single Tour Settings, this information will be used by default.', 'tourfic' ),
								),
								...
								array(
									...
									'type'   => 'textarea',
									'is_pro' => true,
									'label'  => esc_html__( 'Company Description', 'tourfic' ),
								),
								array(
									'id'          => '',
									'type'        => 'text',
									'is_pro'      => true,
									'label'       => esc_html__( 'Company Email Address', 'tourfic' ),
									'field_width' => 33.33,
								),
								array(
									'id'          => '',
									'type'        => 'text',
									'is_pro'      => true,
									'label'       => esc_html__( 'Company Address', 'tourfic' ),
									'field_width' => 33.33,
								),
								array(
									'id'          => '',
									'type'        => 'text',
									'is_pro'      => true,
									'label'       => esc_html__( 'Company Phone', 'tourfic' ),
									'field_width' => 33.33,
								),
								array(
									'id'    => 'export_heading',
									'type'  => 'heading',
									'title' => esc_html__( 'Talk to Expert Section', 'tourfic' ),
								),
								array(
									'id'      => '',
									'type'    => 'switch',
									'is_pro'  => true,
									'label'   => esc_html__( 'Enable Talk To Expert Section in PDF', 'tourfic' ),
									'default' => false,
								),
								array(
									'id'          => '',
									'type'        => 'text',
									'is_pro'      => true,
									'label'       => esc_html__( 'Talk to Expert - Label', 'tourfic' ),
									'field_width' => 25,
									'dependency'  => array(
								...
								array(
									'id'          => '',
									'type'        => 'text',
									'label'       => esc_html__( 'Expert Name', 'tourfic' ),
									'field_width' => 25,
									'is_pro'      => true,
									'dependency'  => array(
										array( 'itinerary-expert', '==', 'true' ),
								...
								array(
									'id'          => '',
									'type'        => 'text',
									'label'       => esc_html__( 'Expert Email Address', 'tourfic' ),
									'field_width' => 25,
									'is_pro'      => true,
									'dependency'  => array(
										array( 'itinerary-expert', '==', 'true' ),
								...
								array(
									'id'          => '',
									'type'        => 'text',
									'label'       => esc_html__( 'Expert Phone Address', 'tourfic' ),
									'field_width' => 25,
									'is_pro'      => true,
									'dependency'  => array(
										array( 'itinerary-expert', '==', 'true' ),
								...
								array(
									...
									'type'       => 'image',
									'is_pro'     => true,
									'label'      => esc_html__( 'Expert Avatar Image', 'tourfic' ),
									'dependency' => array(
										array( 'itinerary-expert', '==', 'true' ),
									),
								),
								array(
									'id'         => '',
									'type'       => 'switch',
									'label'      => esc_html__( 'Enable Viber Contact', 'tourfic' ),
									'dependency' => array(
										array( 'itinerary-expert', '==', 'true' ),
									),
									'is_pro'  => true,
								...
								array(
									...
									'type'       => 'switch',
									'is_pro'  => true,
									'label'      => esc_html__( 'Enable WhatsApp Contact', 'tourfic' ),
									'dependency' => array(
										array( 'itinerary-expert', '==', 'true' ),
									),
								),
								array(
									...
									'type'     => 'heading',
									'title'    => esc_html__( 'PDF Downloader Font Support', 'tourfic' ),
									'content' => esc_html__( 'If your site\'s language is not English, then upload your language font. Otherwise, your Downloader PDF may not work properly.', 'tourfic' ),
								),
								array(
									'id'     => '',
									'type'   => 'file',
									'label'  => esc_html__( 'Upload Fonts', 'tourfic' ),
									'is_pro' => true,
								),
							),
						),
				...
				array(
					'id'          => '',
					'type'        => 'switch',
					'label'       => esc_html__( 'Enable Itinerary Map', 'tourfic' ),
					'label_on'    => esc_html__( 'Yes', 'tourfic' ),
					'label_off'   => esc_html__( 'No', 'tourfic' ),
					'subtitle'  => esc_html__( 'To show the itinerary on a map, it is necessary to add your Google Maps API key in the settings under Miscellaneous -> Map.', 'tourfic' ),
					'is_pro'      => true,
					'field_width' => 50,
				),
				array(
					'id'          => '',
					'type'        => 'select',
					'label'       => esc_html__( 'Map Mode', 'tourfic' ),
					'options'     => array(
						'DRIVING'   => esc_html__( 'Driving', 'tourfic' ),
						'WALKING'   => esc_html__( 'Walking', 'tourfic' ),
						'BICYCLING' => esc_html__( 'Bycycling', 'tourfic' ),
					),
					'default'     => 'driving',
					'is_pro'      => true,
					'field_width' => 50,
		...
		'tour_payment_popup'    => array(
			'title'  => esc_html__( 'Tour Partial Payment', 'tourfic' ),
			'parent' => 'pro_options',
			'icon'   => 'fa fa-cog',
			'fields' => array(
				array(
					'id'    => 'signle_tour_heading',
					'type'  => 'heading',
					'title' => esc_html__( 'Settings for Partial Payment', 'tourfic' ),
					'content'  => esc_html__( 'This option will appear as Popup during Booking.', 'tourfic' ),
				...
				array(
					...
					'type'    => 'text',
					'label'   => esc_html__( 'Label', 'tourfic' ),
					'default' => esc_html__( 'Partial payment of {amount} on total', 'tourfic' ),
					'placeholder' => esc_html__( 'Partial payment of {amount} on total', 'tourfic' ),
					'is_pro' => true,
				),
				array(
					'id'      => '',
					...
					'label'   => esc_html__( 'Description', 'tourfic' ),
					'is_pro' => true,
					'default' => esc_html__( 'You have the option to make a partial payment to secure your tour booking. The remaining balance can then be settled after the tour is completed.', 'tourfic' ),
				),
				array(
					'id'      => 'notice_shortcode',
					'type'    => 'notice',
					'content' => esc_html__( 'Use shortcode <code>{amount}</code> to show percentage amount in Label', 'tourfic' ),
					'is_pro' => true
				),
			),
		),
		...
		'without_payment_book'  => array(
			'title'  => esc_html__( 'Tour Without Payment', 'tourfic' ),
			'parent' => 'pro_options',
			'icon'   => 'fa fa-cog',
			'fields' => array(
				array(
					...
					'type'     => 'heading',
					'title'    => esc_html__( 'Settings for Without Payment Option', 'tourfic' ),
					'content' => esc_html__( 'Activating the "Without Payment" booking option will enable the use of this section.', 'tourfic' ),
				...
				array(
					...
					'type'         => 'repeater',
					'button_title' => esc_html__( 'Add New', 'tourfic' ),
					'label'        => esc_html__( 'Fields for Booking Confirmation', 'tourfic' ),
					'subtitle'     => esc_html__( 'Custom fields allowed', 'tourfic' ),
					'is_pro'       => true,
					...
					'default'      => array(
						array(
							'reg-field-label'    => esc_html__( 'First Name', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_first_name', 'tourfic' ),
							'reg-fields-type'    => 'text',
							'reg-field-required' => true,
						),
						array(
							'reg-field-label'    => esc_html__( 'Last Name', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_last_name', 'tourfic' ),
							'reg-fields-type'    => 'text',
							'reg-field-required' => true,
						),
						array(
							'reg-field-label'    => esc_html__( 'Email', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_email', 'tourfic' ),
							'reg-fields-type'    => 'email',
							'reg-field-required' => true,
						),
						array(
							'reg-field-label'    => esc_html__( 'Phone', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_phone', 'tourfic' ),
							'reg-fields-type'    => 'text',
							'reg-field-required' => true,
						),
						array(
							'reg-field-label'    => esc_html__( 'Country', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_country', 'tourfic' ),
							'reg-fields-type'    => 'text',
							'reg-field-required' => true,
						),
						array(
							'reg-field-label'    => esc_html__( 'Street Address', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_street_address', 'tourfic' ),
							'reg-fields-type'    => 'text',
							'reg-field-required' => true,
						),
						array(
							'reg-field-label'    => esc_html__( 'Town/City', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_town_city', 'tourfic' ),
							'reg-fields-type'    => 'text',
							'reg-field-required' => true,
						),
						array(
							'reg-field-label'    => esc_html__( 'State/Country', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_state_country', 'tourfic' ),
							'reg-fields-type'    => 'text',
							'reg-field-required' => true,
						),
						array(
							'reg-field-label'    => esc_html__( 'Postcode/ZIP', 'tourfic' ),
							'reg-field-name'     => esc_html__( 'tf_postcode', 'tourfic' ),
							'reg-fields-type'    => 'text',
							'reg-field-required' => true,
						),
					),
				...
				array(
					'id'          => '',
					'type'        => 'editor',
					'label'       => esc_html__( 'Booking Confirmation Message', 'tourfic' ),
		...
		// Hotel service Popup
		'payment_popup'         => array(
			'title'  => esc_html__( 'Hotel Popup Settings', 'tourfic' ),
			'parent' => 'pro_options',
			'icon'   => 'fa fa-cog',
			'fields' => array(
				array(
					...
					'type'  => 'heading',
					'title' => esc_html__( 'Settings for Popup', 'tourfic' ),
					'content'   => esc_html__( 'The popup will appear when you enable the airport pickup service.', 'tourfic' ),
					'docs' => esc_url('https://themefic.com/docs/tourfic/tourfic-settings/tourfic-hotel-options/#popup')
				),
				array(
					'id'    => '',
					'type'  => 'text',
					'label' => esc_html__( 'Hotel Service Popup Title', 'tourfic' ),
					'is_pro' => true,
				),
				...
				array(
					'id'     => '',
					'type'   => 'textarea',
					'label'  => esc_html__( 'Hotel Service Popup Description', 'tourfic' ),
					'is_pro' => true,
				),
				...
				array(
					'id'      => '',
					'type'    => 'text',
					'label'   => esc_html__( 'Popup Button Text', 'tourfic' ),
					'default' => esc_html__( 'Continue to booking', 'tourfic' ),
					'is_pro'  => true,
				)
			),
		),
