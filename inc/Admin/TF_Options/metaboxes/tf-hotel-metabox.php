...
TF_Metabox::metabox( 'tf_hotels_opt', array(
	'title'     => esc_html__( $hotel_name . ' Settings', 'tourfic' ),
	'post_type' => 'tf_hotel',
	'sections'  => array(
		'general' => array(
			...
			'fields' => array(
				...
				array(
					...
					'subtitle' => esc_html__( 'You can keep the Global Template settings or choose a different layout for this ' . strtolower($hotel_name) . '.', 'tourfic' ),
					'options'  => [
		...
		'hotel_info' => array(
			...
			'fields' => array(
				...
				array(
					'id'           => 'nearby-places',
					'type'         => 'repeater',
					'label'        => esc_html__( 'Insert / Create your ' . $hotel_name . ' Place', 'tourfic' ),
					...
					'fields'       => array(
						...
						array(
							...
							'subtitle'    => esc_html__( 'Distance of the place from the ' . strtolower($hotel_name) . ' with Unit', 'tourfic' ),
							'field_width' => 50,
							'attributes'  => array(
								'min' => '0',
							),
		...
		'hotel_details'    => array(
			...
			'fields' => array(
				...
				array(
					...
					'subtitle'    => __( 'If you have an enticing video of your ' . strtolower($hotel_name) . ', simply upload it to YouTube or Vimeo and insert the URL here to showcase it to your guests.', 'tourfic' ),
		...
		'room_details'     => array(
			...
			'fields' => array(
				...
				array(
					...
					'type'    => 'notice',
					'notice'  => 'info',
					'content' => __( 'This section includes ' . strtolower($hotel_name) . ' Room Management settings.', 'tourfic' ). ' <a href="https://themefic.com/docs/tourfic/how-it-works/room-management/" target="_blank" class="tf-admin-btn tf-btn-secondary tf-small-btn"><strong>' . __( 'Check our Documentation', 'tourfic' ) . '</strong></a>',
				),
				array(
				...
				array(
					'id'          => 'tf_rooms',
					'type'        => 'select2',
					'label'        => __( 'Manage Your ' . $hotel_name . ' Rooms', 'tourfic' ),
		...
		'terms_conditions' => array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'Include your set of regulations and guidelines that guests must agree to in order to use the service provided in your ' . strtolower($hotel_name) . '. ', 'tourfic' ),
				),
				array(
					'id'      => 'hotel-tnc-docs',
					'type'    => 'notice',
				...
				array(
					...
					'default' => $hotel_name . " Terms & Conditions"
				),
				array(
					'id'    => 'tc',
					'type'  => 'editor',
					'label' => __( $hotel_name . ' Terms & Conditions', 'tourfic' ),
					'subtitle'    => __( "Enter your " . strtolower($hotel_name) . "'s terms and conditions in the text editor provided below.", 'tourfic' ),
				),
			),
		),
		// Settings
		'settings'         => array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'These are some additional settings specific to this ' . strtolower($hotel_name) . '. Note that some of these settings may override the global settings. ', 'tourfic' ),
				),
				array(
