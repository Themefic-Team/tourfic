		...
		'information'          => array(
			...
			'fields' => array(
				...
				array(
					...
					'content' => wp_kses_post(esc_html__( 'We\'re offering some extra features like <b>tour type</b> in our pro plan. <a href="https://tourfic.com/" target="_blank"> Upgrade to our pro package today to take advantage of these fantastic options!</a>', 'tourfic' ) ),
				),
			),
		),
		// Contact Info
		...
		'tour_extra'           => array(
			...
			'fields' => array(
				...
				array(
					...
					'notice' => 'info',
					'icon' => 'ri-information-fill',
					'content' => wp_kses_post(esc_html__( 'Are you interested in enriching your tour offerings with exciting services? With our Pro package, you can easily add exciting activities such as paragliding, along with meals and hotel accommodations, through our <b>Tour Extra Services</b>. This feature allows you to customize and expand your services as much as you want, providing a better experience for your customers. <a href="https://tourfic.com/" target="_blank">Upgrade to our Pro package today to take advantage of these fantastic options!</a>', 'tourfic' ) ),
				),
			),
		),
		...
		'availability'         => array(
			...
			'fields' => array(
				...
				array(
					...
					'notice' => 'info',
					'icon' => 'ri-information-fill',
					'content' => wp_kses_post(esc_html__( 'We\'re offering some extra features like <b>fixed tour type</b>, <b>custom availability</b>, <b>allowed time</b>, <b>select day to disable</b>, <b>disable specific dates</b> in our pro plan. <a href="https://tourfic.com/" target="_blank">Upgrade to our pro package today to take advantage of these fantastic options!</a>', 'tourfic' )),
				),
