            ...
            ?>
                <div class="tf-critical-update-notice notice notice-error" style="background: #FFECEC; padding: 20px 12px;">
                    <p>
                        <?php
                        /* translators: %s: URL */
                        echo wp_kses_post( sprintf( __('<b style="color:#d63638;">NOTICE: </b> Please <a href="%s"><b>Activate</b></a> your Tourfic Pro license. You can get your license key from our Client Portal -> Support -> License Keys.','tourfic'),
