            ...
            ?>
                <div class="wrap tf_booking_details_wrap tf-enquiry-details-wrap" style="margin-right: 20px;">
                    ...
                    <div class="tf_enquiry_details_wrap_header">
						<h1 class="wp-heading-inline"><?php echo  esc_html( apply_filters( 'tf_tour_enquiry_page_heading', esc_html__( 'Tour Enquiry Details', 'tourfic' ) ) ); ?></h1>
                    ...
                    $paged = !empty( $_GET['paged'] ) ? sanitize_text_field( $_GET["paged"]) : 1; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                    $per_page = 20;
