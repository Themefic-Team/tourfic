                ...
                <div class="notice notice-success tf_black_friday_20222_admin_notice">
                    <a href="<?php echo $deal_link; ?>" target="_blank">
                        <img style="width: auto; height: 100px;"
                             src="<?php echo TOURFIC_PLUGIN_URL ?>/assets/img/BLACK_FRIDAY_BACKGROUND_GRUNGE.jpg"
                             alt="">
                    </a>
...
if ( ! function_exists( 'tf_black_friday_20222_hotel_tour_docs' ) ) {
	...
	function tf_black_friday_2022_callback_hotel() {
        ...
        <div class="back_friday_2022_preview" style="text-align: center; overflow: hidden;">
            <a href="<?php echo $deal_link; ?>" target="_blank">
                <img style="width: 100%; transform: scale(1.3);"
                     src="<?php echo TOURFIC_PLUGIN_URL ?>/assets/img/BLACK_FRIDAY_BACKGROUND_GRUNGE.jpg" alt="">
            </a>
        </div>
		<?php
	}
                ...
                <form id="ask-question" action="" method="post">
                    ...
                    <div class="tf-aq-field">
                        <input type="email" name="your-email"
                               placeholder="<?php esc_attr_e( 'Your email', 'tourfic' ); ?>" required/>
                    </div>
                    <div class="tf-aq-field">
                        <textarea placeholder="<?php esc_attr_e( 'Your Question', 'tourfic' ); ?>" name="your-question"
                                  required></textarea>
                    </div>
                    <div class="tf-aq-field">
                        <button type="reset"
                                class="screen-reader-text"><?php esc_html_e( 'Reset', 'tourfic' ); ?></button>
...
function tourfic_ask_question_ajax() {
	...
	$author_mail       = get_the_author_meta( 'user_email', $tf_post_author_id );
	...
	function tf_array_flatten( $array, $depth = INF ) {
		...
		foreach ( $array as $item ) {
			if ( ! is_array( $item ) ) {
				...
				$values = $depth === 1 ? array_values( $item ) : tf_array_flatten( $item, $depth - 1 );
