...
function tf_room_availability_callback() {
	...
	// Check nonce security
	if ( ! empty( $_POST['tf_room_avail_nonce'] ) && ! wp_verify_nonce( sanitize_text_field(wp_unslash($_POST['tf_room_avail_nonce'])), 'check_room_avail_nonce' ) ) {
		return;
	}
...
//	add_action( 'wp_ajax_nopriv_tf_hotel_booking_popup', 'tf_hotel_booking_popup_callback' );
	...
	function tf_hotel_booking_popup_callback() {
		// Check nonce security
		if ( ! empty( $_POST['tf_room_booking_nonce'] ) && ! wp_verify_nonce( sanitize_text_field(wp_unslash($_POST['tf_room_booking_nonce'])), 'check_room_booking_nonce' ) ) {
			return;
		}
