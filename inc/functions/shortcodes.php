									...
									if ( $post_type == 'tf_hotel' ) {
										...
										if ( ! empty( $data ) ) {
											if ( isset( $data[3] ) && isset( $data[4] ) ) {
												...
												if( $tour_meta["tour_as_featured"] ) tf_tour_archive_single_item( $adults, $child, $check_in_out );
											}
										} else {
...
/**
 * Hotel External listing
 * @author Foysal
 * @since 2.10.4
 */
add_shortcode( 'tf_hotel_external_listings', 'tf_hotel_external_listings_shortcode' );
function tf_hotel_external_listings_shortcode( $atts, $content = null ) {
	extract(
		shortcode_atts(
			array(
				'title'     => '',
    ...
    $external_post_ids = tf_get_external_post_ids('hotel', $locations);
...
/**
 * Tour External listing
 * @author Foysal
 * @since 2.10.4
 */
add_shortcode( 'tf_tour_external_listings', 'tf_tour_external_listings_shortcode' );
function tf_tour_external_listings_shortcode( $atts, $content = null ) {
	extract(
		shortcode_atts(
			array(
				'title'     => '',
	...
	$external_post_ids = tf_get_external_post_ids('tour', $locations);
...
/**
 * Apartment External listing
 * @author Foysal
 * @since 2.10.4
 */
add_shortcode( 'tf_apartment_external_listings', 'tf_apartment_external_listings_shortcode' );
function tf_apartment_external_listings_shortcode( $atts, $content = null ) {
	extract(
		shortcode_atts(
			array(
				'title'     => '',
	...
	$external_post_ids = tf_get_external_post_ids('apartment', $locations);
