                        ...
                        <a href="<?php echo $term_link; ?>">
                            <div class="single_recomended_content" style="background-image: url(<?php echo $image_url; ?>);">
                                <div class="recomended_place_info_header">
                                    ...
                                    <p><?php printf(esc_html__("%s properties", TFD), $term->count); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <div id="tf-booking-search-tabs">
        ...
        ?>
            ...
            <div class="tf-booking-form-tab">
                <button class="tf-tablinks active" onclick="tfOpenForm(event, 'tf-hotel-booking-form')"><?php _e('Hotel', TFD); ?></button>
                <button class="tf-tablinks" onclick="tfOpenForm(event, 'tf-tour-booking-form')"><?php _e('Tour', TFD); ?></button>
            </div>
