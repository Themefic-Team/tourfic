...
if ( ! function_exists( 'tf_car_search_ajax_callback' ) ) {
	function tf_car_search_ajax_callback() {
		...
		if(!empty($_POST['same_location']) && 'on' == $_POST['same_location']){
...
function tf_car_price_calculation_callback() {
	...
	$response_data                = $booking_adjustments['response_data'];
	$response_data['total_price'] = tf_car_get_total_price_display_html( $total_prices, $total_regular_prices );
