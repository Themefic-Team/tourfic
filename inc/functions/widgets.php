    ...
    public function widget( $args, $instance ) {
        ...
        if ( $posttype == 'tf_hotel' ) {
            ...
            foreach ( $get_terms as $key => $term ) {
                ...
                echo wp_kses_post("<li class='filter-item'><label><input type='checkbox' name='tf_filters[]' value='{$id}' {$defult_select}/><span class='checkmark'></span> {$name}</label> {$count}</li>");
            }
    ...
    public function widget( $args, $instance ) {
        ...
        if ( $posttype == 'tf_hotel' ) {
            ...
            foreach ( $get_terms as $key => $term ) {
                ...
                echo wp_kses_post("<li class='filter-item'><label><input type='checkbox' name='tf_hotel_types[]' value='{$id}' {$defult_select}/><span class='checkmark'></span> {$name}</label> {$count}</li>");
            }
            echo "</ul><a href='#' class='see-more btn-link'>" . esc_html__( 'See more', 'tourfic' ) . "<span class='fa fa-angle-down'></span></a><a href='#' class='see-less btn-link'>" . esc_html__( 'See Less', 'tourfic' ) . "<span class='fa fa-angle-up'></span></a></div>";
    ...
    public function widget( $args, $instance ) {
        ...
        if ( $posttype == 'tf_tours' ) {
            ...
            foreach ( $get_terms as $key => $term ) {
                ...
                echo wp_kses_post("<li class='filter-item'><label><input type='checkbox' name='tour_features[]' value='{$id}'/><span class='checkmark'></span> {$name}</label> {$count}</li>");
            }
            echo "</ul><a href='#' class='see-more btn-link'>" . esc_html__( 'See more', 'tourfic' ) . "<span class='fa fa-angle-down'></span></a><a href='#' class='see-less btn-link'>" . esc_html__( 'See Less', 'tourfic' ) . "<span class='fa fa-angle-up'></span></a></div>";
    ...
    public function widget( $args, $instance ) {
        ...
        if ( $posttype == 'tf_tours' ) {
            ...
            foreach ( $get_terms as $key => $term ) {
                ...
                echo wp_kses_post("<li class='filter-item'><label><input type='checkbox' name='tf_attractions[]' value='{$id}'/><span class='checkmark'></span> {$name}</label> {$count}</li>");
            }
            echo "</ul><a href='#' class='see-more btn-link'>" . esc_html__( 'See more', 'tourfic' ) . "<span class='fa fa-angle-down'></span></a><a href='#' class='see-less btn-link'>" . esc_html__( 'See Less', 'tourfic' ) . "<span class='fa fa-angle-up'></span></a></div>";
    ...
    public function widget( $args, $instance ) {
        ...
        if ( $posttype == 'tf_tours' ) {
            ...
            foreach ( $get_terms as $key => $term ) {
                ...
                echo wp_kses_post("<li class='filter-item'><label><input type='checkbox' name='tf_activities[]' value='{$id}'/><span class='checkmark'></span> {$name}</label> {$count}</li>");
            }
            echo "</ul><a href='#' class='see-more btn-link'>" . esc_html__( 'See more', 'tourfic' ) . "<span class='fa fa-angle-down'></span></a><a href='#' class='see-less btn-link'>" . esc_html__( 'See Less', 'tourfic' ) . "<span class='fa fa-angle-up'></span></a></div>";
	...
	public function widget( $args, $instance ) {
		...
		if ( $posttype == 'tf_tours' ) {
			...
			foreach ( $get_terms as $key => $term ) {
				...
				$count = $show_count ? '<span>(' . $default_count . ')</span>' : '';
				$defult_select =  in_array($fslug, $search_types_query) ? 'checked' : '';
				echo wp_kses_post("<li class='filter-item'><label><input type='checkbox' name='tf_tour_types[]' value='{$id}' {$defult_select}/><span class='checkmark'></span> {$name}</label> {$count}</li>");
			}
			echo "</ul><a href='#' class='see-more btn-link'>" . esc_html__( 'See more', 'tourfic' ) . "<span class='fa fa-angle-down'></span></a><a href='#' class='see-less btn-link'>" . esc_html__( 'See Less', 'tourfic' ) . "<span class='fa fa-angle-up'></span></a></div>";
	...
	public function widget( $args, $instance ) {
		...
		if ( $posttype == 'tf_apartment' ) {
			...
			foreach ( $get_terms as $key => $term ) {
				...
				$count = $show_count ? '<span>' . ( $default_count ) . '</span>' : '';
				$defult_select =  in_array($fslug, $search_types_query) ? 'checked' : '';
				echo wp_kses_post("<li class='filter-item'><label><input type='checkbox' name='tf_apartment_features[]' value='{$id}' {$defult_select}/><span class='checkmark'></span> {$name}</label> {$count}</li>");
			}
			echo "</ul><a href='#' class='see-more btn-link'>" . esc_html__( 'See more', 'tourfic' ) . "<span class='fa fa-angle-down'></span></a><a href='#' class='see-less btn-link'>" . esc_html__( 'See Less', 'tourfic' ) . "<span class='fa fa-angle-up'></span></a></div>";
	...
	public function widget( $args, $instance ) {
		...
		if ( $posttype == 'tf_apartment' ) {
			...
			foreach ( $get_terms as $key => $term ) {
				...
				$count = $show_count ? '<span>' . ( $default_count ) . '</span>' : '';
				$defult_select =  in_array($fslug, $search_types_query) ? 'checked' : '';
				echo wp_kses_post("<li class='filter-item'><label><input type='checkbox' name='tf_apartment_types[]' value='{$id}' {$defult_select}/><span class='checkmark'></span> {$name}</label> {$count}</li>");
			}
			echo "</ul><a href='#' class='see-more btn-link'>" . esc_html__( 'See more', 'tourfic' ) . "<span class='fa fa-angle-down'></span></a><a href='#' class='see-less btn-link'>" . esc_html__( 'See Less', 'tourfic' ) . "<span class='fa fa-angle-up'></span></a></div>";
