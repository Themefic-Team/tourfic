    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                $actions_details .= '<a href="'.admin_url().'post.php?post='.$tour['order_id'].'&amp;action=edit" class="tf_booking_details_view"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
