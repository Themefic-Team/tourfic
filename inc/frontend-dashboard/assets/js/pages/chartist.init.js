...
chart.on("created", function () {
    ...
    var t, a, n;
    seq++, "line" === e.type ? e.element.animate({opacity: {begin: seq * delays + 1e3, dur: durations, from: 0, to: 1}}) : "label" === e.type && "x" === e.axis ? e.element.animate({
        y: {
            begin: seq * delays,
            dur: durations,
            from: e.y + 100,
        ...
        x1: {begin: seq * delays, dur: durations, from: e.x - 10, to: e.x, easing: "easeOutQuart"},
    ...
    }) : "grid" === e.type && (t = {begin: seq * delays, dur: durations, from: e[e.axis.units.pos + "1"] - 30, to: e[e.axis.units.pos + "1"], easing: "easeOutQuart"}, a = {
        begin: seq * delays,
        dur: durations,
        from: e[e.axis.units.pos + "2"] - 100,
        to: e[e.axis.units.pos + "2"],
        easing: "easeOutQuart"
    }, (n = {})[e.axis.units.pos + "1"] = t, n[e.axis.units.pos + "2"] = a, n.opacity = {begin: seq * delays, dur: durations, from: 0, to: 1, easing: "easeOutQuart"}, e.element.animate(n))
}), chart.on("created", function () {
...
}), new Chartist.Line("#simple-line-chart", {labels: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"], series: [[12, 9, 7, 8, 5], [2, 1, 3.5, 7, 3], [1, 3, 4, 5, 6]]}, {
    fullWidth: !0,
...
/*new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#chart-with-area", {labels: [1, 2, 3, 4, 5, 6, 7, 8], series: [[5, 9, 7, 8, 5, 3, 5, 4]]}, {
    low: 0,
    showArea: !0,
    plugins: [Chartist.plugins.tooltip()]
});*/
...
}), (chart = new Chartist.Pie("#animating-donut", {series: [10, 20, 50, 20, 5, 50, 15], labels: [1, 2, 3, 4, 5, 6, 7]}, {donut: !0, showLabel: !1, plugins: [Chartist.plugins.tooltip()]})).on("draw", function (e) {
    var t, a;
    "slice" === e.type && (t = e.element._node.getTotalLength(), e.element.attr({"stroke-dasharray": t + "px " + t + "px"}), a = {
        "stroke-dashoffset": {
            id: "anim" + e.index,
            dur: 1e3,
            from: -t + "px",
...
var data = {series: [5, 3, 4]}, sum = function (e, t) {
    return e + t
};
