                ...
                <div class="tf_content tf_content-full mb-15">
                    ...
                    <div class="tf_title-area">
                        ...
                        <div class="tf_title-right">
                            ...
                            ?>
                                        <a class="tf-wishlist-button" title="<?php _e('Click to toggle wishlist', TFD); ?>"><i class="<?php echo $has_in_wishlist ? 'fas tf-text-red remove-wishlist' : 'far add-wishlist'  ?> fa-heart" data-nonce="<?php echo wp_create_nonce("wishlist-nonce") ?>" data-id="<?php echo $post_id ?>" data-type="<?php echo $post_type ?>" <?php if (tfopt('wl-page')) {
                                        ...
                                        <ul class="tf-dropdown__content">
                                            <li>
                                                <a href="http://www.facebook.com/share.php?u=<?php _e($share_link); ?>" class="tf-dropdown__item" target="_blank">
                                                    <span class="tf-dropdown__item-content"><?php echo tourfic_get_svg('facebook'); ?>
                                                        <?php esc_html_e('Share on Facebook', TFD); ?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="http://twitter.com/share?text=<?php _e($share_text); ?>&url=<?php _e($share_link); ?>" class="tf-dropdown__item" target="_blank">
                                                    <span class="tf-dropdown__item-content"><?php echo tourfic_get_svg('twitter'); ?>
                                                        <?php esc_html_e('Share on Twitter', TFD); ?></span>
                                                </a>
                                            </li>
                                            <li>
                                                <div class="share_center_copy_form tf-dropdown__item" title="Share this link" aria-controls="share_link_button">
                                                    <label class="share_center_copy_label" for="share_link_input"><?php esc_html_e('Share this link', TFD); ?></label>
                                                    ...
                                                    <button id="share_link_button" class="share_center_copy_cta" tabindex="0" role="button">
                                                        <span class="tf-button__text share_center_copy_message"><?php esc_html_e('Copy link', TFD); ?></span>
                                                        <span class="tf-button__text share_center_copied_message"><?php esc_html_e('Copied!', TFD); ?></span>
                                                    </button>
                                                </div>
                                            </li>
                                        </ul>
                            ...
                            <?php if (!empty($map["address"])) { ?>
                                <div class="show-on-map">
                                    <a href="https://www.google.com/maps/search/<?php echo $map["address"]; ?>" target="_blank" class="tf_button btn-outline button"><?php esc_html_e('Show on map', TFD); ?></a>
                                </div>
                            <?php } ?>
                            <div class="reserve-button">
                                <a href="#rooms" class="tf_button button"><?php esc_html_e('Reserve', TFD); ?></a>
                            </div>
                        </div>
                    </div>
                    <!-- End title area -->
                    ...
                    <?php if ($locations) { ?>
                        ...
                        <div class="tf_map-link">
                            ...
                            <a href="<?php echo $first_location_url; ?>" class="tf-d-ib">
                                <?php printf(__('Show more hotels in %s', TFD), $first_location_name); ?>
                            </a>
                        </div>
                        <!-- End map link -->
                    <?php } ?>
                ...
                <div class="tf_content">
                    ...
                    <div class="tf_contents">
                        <div class="listing-title">
                            <h4><?php esc_html_e('Description', TFD); ?></h4>
                        </div>
                        <?php the_content(); ?>
                    </div>
                    <!-- End description -->
                    ...
                    <?php if ($features) { ?>
                        ...
                        <div class="tf_features">
                            <div class="listing-title">
                                <h4><?php esc_html_e('Features', TFD); ?></h4>
                            </div>
                                                    ...
                                                    <td class="description">
                                                        ...
                                                        <?php if (!empty($room['features'])) { ?>
                                                            <div class="room-features">
                                                                <div class="tf-room-title"><?php esc_html_e('Amenities', TFD); ?>
                                                                </div>
                                                    ...
                                                    <td class="pricing">
                                                        <div class="tf-price-column">
                                                            <?php if ($pricing_by == '1') { ?>
                                                                ...
                                                                <div class="price-per-night"><?php esc_html_e('per night', TFD); ?>
                                                                </div>
                                                            <?php } elseif ($pricing_by == '2') { ?>
                                                                <span class="tf-price"><?php echo wc_price($room['adult_price']); ?></span>
                                                                <div class="price-per-night">
                                                                    <?php esc_html_e('per person/night', TFD); ?></div>
                                                            <?php } ?>
                                                        </div>
                                                    </td>
                                                    <td class="reserve tf-t-c">
                                                        <button class="hotel-room-availability" type="submit"><?php _e('Check Availability', TFD); ?></button>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
