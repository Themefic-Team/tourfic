<div class="tf-template-3">
    ...
    $tf_hotel_arc_banner = ! empty( tf_data_types(Helper::tfopt( 'tf-template' ))['apartment_archive_design_1_bannar'] ) ?  tf_data_types(Helper::tfopt( 'tf-template' ))['apartment_archive_design_1_bannar'] : '';
    ?>
    <!--Hero section start -->
