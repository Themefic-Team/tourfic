                            ...
                            <div class="tf-hero-bottom-right">
                                ...
                                <div class="tf-hero-rating">
                                    ...
                                    <div class="tf-hero-bcr-num reviews">
                                        <span> <?php _e(tf_average_ratings($tf_overall_rate['review'] ?? [])); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="tf-suggestion-items-wrapper">
							        <?php
								        while ( $tours->have_posts() ) {
									        ...
									        ?>
                                            <div class="tf-suggestion-item" style="background-image: url(<?php
                                                        ...
                                                        <h3>
                                                            <a href="<?php
														        the_permalink() ?>"><?php
															        the_title() ?></a>
                                                            <span><?php
															        echo $first_destination_name; ?></span>
                                                        </h3>
                                                    </div>
                                                    <div class="tf-suggestion-rating">
												        <?php

													        if ( count( $related_comments ) ) {
														        $related_overall_rate = [];
														        foreach ( $related_comments as $related_comment ) {
															        tf_calculate_user_ratings( $related_comment, $related_overall_rate );
														        }
                                                                ...
                                                                <div class="tf-suggestion-rating-star">
                                                                    <i class="fas fa-star"></i> <span
                                                                            style="color:#fff;"><?php
																	        echo tf_average_ratings( $related_overall_rate['review'] ?? [] ); ?></span>
                                                                </div>
														        <?php
							    ...
							    <?php
								    if ( count( $comments ) > 0 ) { ?>
                                        ...
                                        <div class="tf-review-items-wrapper">
										    <?php
											    foreach ( $comments as $comment ) {
												    $tf_single_overall_rate = [];
												    tf_calculate_user_ratings( $comment, $tf_single_overall_rate );
												    ?>
                                                    <div class="tf-review-item">
                                                        <div class="tf-review-rating">
                                                            <i class="fas fa-star"></i>
                                                            <span><?php
																    _e( $tf_single_overall_rate['review'][0] ); ?></span>
                                                        </div>
