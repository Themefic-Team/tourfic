<div class="tf-template-3">
    ...
    $tf_tour_arc_banner = ! empty( tf_data_types(Helper::tfopt( 'tf-template' ))['tour_archive_design_2_bannar'] ) ?  tf_data_types(Helper::tfopt( 'tf-template' ))['tour_archive_design_2_bannar'] : '';
    ?>  
    <!--Hero section start -->
