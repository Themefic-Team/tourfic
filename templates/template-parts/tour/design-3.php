...
<div class="tf-template-3 tf-tour-single tf-single-template__three">
    ...
    <div class="tf-content-wrapper tf-single-pb-56">
        ...
        <div class="tf-container">
					...
					if ( ! empty( Helper::tf_data_types( Helper::tfopt( 'tf-template' ) )['single-tour-layout-part-1'] ) ) {
						foreach ( Helper::tf_data_types( Helper::tfopt( 'tf-template' ) )['single-tour-layout-part-1'] as $section ) {
							if ( ! empty( $section['tour-section-status'] ) && $section['tour-section-status'] == "1" && ! empty( $section['tour-section-slug'] ) ) {
								include TF_TEMPLATE_PART_PATH . 'tour/design-3/' . $section['tour-section-slug'] . '.php';
							}
						}
					} else {
						include TF_TEMPLATE_PART_PATH . 'tour/design-3/description.php';
						include TF_TEMPLATE_PART_PATH . 'tour/design-3/information.php';
						include TF_TEMPLATE_PART_PATH . 'tour/design-3/highlights.php';
						include TF_TEMPLATE_PART_PATH . 'tour/design-3/include-exclude.php';
						include TF_TEMPLATE_PART_PATH . 'tour/design-3/itinerary.php';
					}
					?>
					...
					if ( ! empty( $tf_enquiry_section_status ) ) {
                        ...
                        <div class="tf-send-inquiry tf-single-widgets">
							...
							if ( ! empty( $tf_enquiry_section_button ) ) {
								?>
                                <div class="tf-btn-wrap"><a href="#" id="tf-ask-question-trigger" class="tf-send-inquiry-btn tf_btn tf_btn_large tf_btn_sharp"><span><?php echo esc_html( $tf_enquiry_section_button ); ?></span></a></div>
								<?php
							}
							?>
                        </div>
			...
			if ( ! empty( Helper::tf_data_types( Helper::tfopt( 'tf-template' ) )['single-tour-layout-part-2'] ) ) {
				...
				include TF_TEMPLATE_PART_PATH . 'tour/design-3/faq.php';
				include TF_TEMPLATE_PART_PATH . 'tour/design-3/review.php';
				include TF_TEMPLATE_PART_PATH . 'tour/design-3/trams-condition.php';
			}
			?>
