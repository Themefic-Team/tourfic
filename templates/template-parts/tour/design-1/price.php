    ...
    <div class="tf-trip-info-inner tf-flex tf-flex-space-bttn tf-flex-align-center tf-flex-gap-8">
        ...
        <div class="tf-short-info">
            <ul class="tf-list">
				...
				$tour_availability_raw = isset( $meta['tour_availability'] ) && ! empty( $meta['tour_availability'] ) ? $meta['tour_availability'] : [];
				$tour_availability_data = is_array( $tour_availability_raw ) ? $tour_availability_raw : json_decode( $tour_availability_raw, true );
				$tour_availability_data = ! empty( $tour_availability_data ) ? $tour_availability_data : [];
