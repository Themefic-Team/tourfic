                                            ...
                                            <div class="tf-booking-block">
                                                ...
                                                ?>
                                                    ...
                                                    if ( ! empty( $tf_tour_min_discount ) ) {
                                                        echo $lowest_price. " " . "<span><del>" . strip_tags(wc_price( $tf_tour_full_price )) . "</del></span>";
                                                    } else {
                                                        echo $lowest_price;
                                                    }
                                                    ?>
                                    ...
                                    <div class="tf-slider-item tf-post-box-lists">
                                        <div class="tf-post-single-box">
                                            <div class="tf-image-data">
                                                <img src="<?php echo ! empty( get_the_post_thumbnail_url( $selected_design_post_id, 'full' ) ) ? get_the_post_thumbnail_url( $selected_design_post_id, 'full' ) : TF_APP_ASSETS_URL . '/images/feature-default.jpg'; ?>"
                                                    alt="">
