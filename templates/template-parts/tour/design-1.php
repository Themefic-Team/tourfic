                ...
                <div class="tf-single-details-wrapper tf-mt-30">
                    <div class="tf-single-details-inner tf-flex">
                        <div class="tf-column tf-tour-details-left">
                            ...
                            <div class="tf-tour-bottom-bar">
                                <div class="tf-tour-bottom-bar-inner tf-flex tf-flex-align-center tf-flex-space-bttn tf-flex-gap-24">
                                    <div class="tf-tour-bottom-bar-left">
										<?php
                                    ...
                                    <div class="tf-tour-bottom-bar-right">
                                        <a data-target="#tf-tour-booking-modal" class="tf-btn-normal btn-primary tf-modal-btn">Book Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="tf-slider-item tf-post-box-lists">
                                        <div class="tf-post-single-box">
                                            <div class="tf-image-data">
                                                <img src="<?php echo ! empty( get_the_post_thumbnail_url( $post_id, 'full' ) ) ? get_the_post_thumbnail_url( $post_id, 'full' ) : TF_ASSETS_APP_URL . '/images/feature-default.jpg'; ?>"
                                                     alt="">
