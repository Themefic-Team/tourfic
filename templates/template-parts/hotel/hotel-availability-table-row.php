                                    ...
                                    <div class="tf-hotel-services">
                                        ...
                                        <div class="tf_button_group">
                                            <button class="hotel-room-book tf-btn-normal btn-primary" type="submit"
                                                    style="width: 100%"><?php _e( tfopt( 'hotel_service_popup_action', 'Continue to booking' ), 'tourfic' ); ?></button>
                                        </div>
                                    </div>
                                </div>
						...
						if ( $gallery_limit < 3 ) {
							...
							if ( count( $tf_room_gallery_ids ) > 1 ) { ?>
								...
								<?php if ( 2 == $gallery_limit ) { ?>
                                    <div class="tf-room-gallery tf-popup-buttons tf-room-detail-popup" data-uniqid="<?php echo ! empty( $room['unique_id'] ) ? $room['unique_id'] . $room_id : '' ?>"
                                         data-hotel="<?php echo $form_post_id; ?>" style="background-image: url('<?php echo esc_url( $image_url ); ?>'); ">
                ...
                <div class="tf-available-room-content-left">
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="tf-room-detail-popup" data-uniqid="<?php echo ! empty( $room['unique_id'] ) ? $room['unique_id'] . $room_id : '' ?>"
                               data-hotel="<?php echo $form_post_id; ?>"><?php _e( "View room details", "tourfic" ); ?></a></li>
                    ...
                    <ul>
						...
						if ( ! empty( $room['features'] ) ) {
							if ( count( $room['features'] ) >= 6 ) {
                                ...
                                <li><a href="#" class="tf-room-detail-popup" data-uniqid="<?php echo ! empty( $room['unique_id'] ) ? $room['unique_id'] . $room_id : '' ?>"
                                       data-hotel="<?php echo $form_post_id; ?>"><?php _e( "See all benefits", "tourfic" ); ?></a></li>
								<?php
							}
						}
						?>
