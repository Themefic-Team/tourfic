                ...
                <div class="tf-room-description-box tf-flex">
                    ...
                    <div class="tf-features-infos" style="<?php echo ! empty( $room_preview_img ) ? 'width: 70%' : ''; ?>">
                        ...
                        <ul>
							...
							<?php } ?>
							<?php if ( $bed ) { ?>
                                <li><i class="ri-hotel-bed-line"></i> <?php echo $bed; ?><?php _e( ' Number of Beds', 'tourfic' ); ?></li>
							<?php } ?>
							<?php
            ...
            <td class="reserve">
                <form class="tf-room">
                    ...
                    <div class="room-submit-wrap">
						...
						if ( function_exists( 'is_tf_pro' ) && is_tf_pro() && ! empty( $tour_hotel_service_avail ) && ! empty( $tour_hotel_service_type ) && ( $room_book_by != 2 || empty( $room_book_url ) ) ) {
							?>
                            <a class="tf_air_service tf-sml-btn btn-styled tf-hotel-booking-popup-btn" href="javascript:;" data-room="<?php echo $room_id; ?>"><?php esc_html_e( $tf_hotel_reserve_button_text, 'tourfic' ); ?></a>
