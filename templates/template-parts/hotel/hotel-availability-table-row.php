                ...
                <div class="tf-room-description-box tf-flex">
					...
					if ( ! empty( $room_preview_img ) ) { ?>
                        <div class="tf-room-preview-img">
							...
							if ( $tour_room_details_gall ) {
								?>
                                <a href="#" class="tf-room-detail-qv" data-uniqid="<?php echo ! empty( $room['unique_id'] ) ? esc_attr($room['unique_id'] . $room_id) : '' ?>" data-hotel="<?php echo esc_attr($form_post_id); ?>"
    ...
    <div class="tf-available-room-content">
        <div class="tf-available-room-content-left">
            ...
            <ul>
                ...
                <?php } ?>
                <li><a href="#" class="tf-room-detail-popup" data-uniqid="<?php echo !empty($room['unique_id']) ? esc_attr($room['unique_id'].$room_id) : '' ?>" data-hotel="<?php echo esc_attr($form_post_id); ?>"><?php esc_html_e("View room details", "tourfic"); ?></a></li>
            ...
            if(!empty($room['features'])){
                ...
                <li><a href="#" class="tf-room-detail-popup" data-uniqid="<?php echo !empty($room['unique_id']) ? esc_attr($room['unique_id'].$room_id) : '' ?>" data-hotel="<?php echo esc_attr($form_post_id); ?>"><?php esc_html_e("See all benefits", "tourfic"); ?></a></li>
                <?php
                }
            }
            ?>
...
<tr>
    <td class="description">
        <div class="tf-room-type">
            ...
            if ($tour_room_details_gall){
            ?>
            <h3><a href="#" class="tf-room-detail-qv" data-uniqid="<?php echo !empty($room['unique_id']) ? esc_attr($room['unique_id'].$room_id) : '' ?>" data-hotel="<?php echo esc_attr($form_post_id); ?>" style="text-decoration: underline;">
