...
<div class="tf-single-template__four">
            ...
            <div class="tf-details">
                <div class="tf-details-left">
					...
					if ( ! empty( tf_data_types( Helper::tfopt( 'tf-template' ) )['single-hotel-layout-3'] ) ) {
						foreach ( tf_data_types( Helper::tfopt( 'tf-template' ) )['single-hotel-layout-3'] as $section ) {
							if ( ! empty( $section['hotel-section-status'] ) && $section['hotel-section-status'] == "1" && ! empty( $section['hotel-section-slug'] ) ) {
								include TF_TEMPLATE_PART_PATH . 'hotel/design-4/' . $section['hotel-section-slug'] . '.php';
							}
						}
					} else {
						include TF_TEMPLATE_PART_PATH . 'hotel/design-4/description.php';
						include TF_TEMPLATE_PART_PATH . 'hotel/design-4/rooms.php';
						include TF_TEMPLATE_PART_PATH . 'hotel/design-4/facilities.php';
						include TF_TEMPLATE_PART_PATH . 'hotel/design-4/faq.php';
						include TF_TEMPLATE_PART_PATH . 'hotel/design-4/review.php';
						include TF_TEMPLATE_PART_PATH . 'hotel/design-4/trams-condition.php';
					}
					?>
                </div>
