...
<div class="tf-facilities-wrapper" id="tf-hotel-facilities">
    <h2 class="tf-section-title"><?php echo !empty($meta['facilities-section-title']) ? esc_html__($meta['facilities-section-title'], 'tourfic') : esc_html__("Property facilities", 'tourfic'); ?></h2>          
