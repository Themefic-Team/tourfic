    ...
    <div class="tf-overview-description">
        <div class="tf-short-description">
			...
			if ( strlen( get_the_content() ) > 300 ) {
				echo wp_kses_post( wp_strip_all_tags( tourfic_character_limit_callback( get_the_content(), 300 ) ) ) . '<span class="tf-see-description">' . esc_html__( 'See more', 'tourfic' ) . '</span>';
			} else {
				the_content();
			}
			?>
