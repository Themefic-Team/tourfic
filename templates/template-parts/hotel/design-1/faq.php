...
$tourfic_enquiry_section_status = !empty($tourfic_meta['h-enquiry-section']) ? $tourfic_meta['h-enquiry-section'] : "";
if ( $tourfic_faqs ): ?>
<div class="tf-hotel-faqs-section tf-mb-50 tf-template-section">
    <h2 class="tf-title tf-section-title" ><?php echo !empty($tourfic_meta['faq-section-title']) ? esc_html($tourfic_meta['faq-section-title']) : ''; ?></h2>
