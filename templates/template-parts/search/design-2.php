                ...
                <div class="tf-head-title">
                    ...
                    ?>
                        <div class="tf-title-meta">
                            <p>( <?php echo apply_filters('tf_guest_count', esc_html( $tf_adults + $tf_children )); ?> <?php esc_html_e("Guest", "tourfic"); ?>, <?php echo !empty($_GET['check-in-out-date']) ? esc_html( sanitize_text_field( wp_unslash($_GET['check-in-out-date'])) ) : '' ?> )</p>
                        </div>
