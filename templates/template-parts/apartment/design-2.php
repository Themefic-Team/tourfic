...
<div class="tf-template-3 tf-hotel-single tf-apartment-single tf-single-template__three">
<!--Hero section start -->
...
<div class="tf-content-wrapper tf-single-pb-56">
    ...
    <div class="tf-details" id="tf-apartment-overview">
        <div class="tf-details-left">
            ...
            if( !empty(Helper::tf_data_types(Helper::tfopt( 'tf-template' ))['single-aprtment-layout-part-1']) ){
                ...
                include TF_TEMPLATE_PART_PATH . 'apartment/design-2/description.php';
                include TF_TEMPLATE_PART_PATH . 'apartment/design-2/features.php';
                include TF_TEMPLATE_PART_PATH . 'apartment/design-2/rooms.php';
                include TF_TEMPLATE_PART_PATH . 'apartment/design-2/offer.php';
                include TF_TEMPLATE_PART_PATH . 'apartment/design-2/rules.php';
                include TF_TEMPLATE_PART_PATH . 'apartment/design-2/facilities.php';
            }
            ?>
    ...
    if( !empty(Helper::tf_data_types(Helper::tfopt( 'tf-template' ))['single-aprtment-layout-part-2']) ){
        ...
        include TF_TEMPLATE_PART_PATH . 'apartment/design-2/review.php';
        include TF_TEMPLATE_PART_PATH . 'apartment/design-2/faq.php';
        include TF_TEMPLATE_PART_PATH . 'apartment/design-2/trams-condition.php';
    }
    ?>
