<div class="tf-car-info" id="tf-car-info">
    ...
    <ul>
        ...
        <li class="tf-flex tf-flex-align-center tf-flex-gap-6">
            ...
            <?php echo 'paid'==$shuttle_car_fee_type && !empty($shuttle_car_fee) ? wc_price($shuttle_car_fee) : esc_html__('Free', 'tourfic'); ?>
            <div class="tf-car-info-tooltip">
                <span><?php esc_html_e("Shuttle", "tourfic"); ?> <?php echo 'paid'==$shuttle_car_fee_type && !empty($shuttle_car_fee) ? esc_html__('Fee:', 'tourfic'). wc_price($shuttle_car_fee) : esc_html__('Fee: Free', 'tourfic'); ?></span>
            </div>
        </li>
        <?php } ?>
