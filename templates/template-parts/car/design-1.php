                            ...
                            <div class="tf-select-date">
                                <div class="tf-flex tf-flex-gap-4">
                                    ...
                                    <div class="info-select">
                                        ...
                                        <input type="text" placeholder="Pick Up Location" id="tf_pickup_location" value="<?php echo !empty($_GET['pickup']) ? sanitize_text_field( wp_unslash($_GET['pickup']) ) : ''; ?>" />
                                        <input type="hidden" id="tf_pickup_location_id" value="<?php echo !empty($_GET['pickup']) ? sanitize_text_field( wp_unslash($_GET['pickup']) ) : ''; ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tf-select-date">
                                <div class="tf-flex tf-flex-gap-4">
                                    ...
                                    <div class="info-select">
                                        ...
                                        <input type="text" placeholder="Drop Off Location" id="tf_dropoff_location" value="<?php echo !empty($_GET['dropoff']) ? sanitize_text_field( wp_unslash($_GET['dropoff']) ) : ''; ?>" />
                                        <input type="hidden" id="tf_dropoff_location_id" value="<?php echo !empty($_GET['dropoff']) ? sanitize_text_field( wp_unslash($_GET['dropoff']) ) : ''; ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tf-select-date">
                                <div class="tf-flex tf-flex-gap-4">
                                    ...
                                    <div class="info-select">
                                        ...
                                        <input type="text" placeholder="<?php esc_html_e("Pick Up Date", "tourfic"); ?>" id="tf_pickup_date" class="tf_pickup_date" value="<?php echo !empty($_GET['pickup_date']) ? sanitize_text_field( wp_unslash($_GET['pickup_date']) ) : esc_attr(gmdate('Y/m/d', strtotime('+1 day'))); ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tf-select-date">
                                <div class="tf-flex tf-flex-gap-4">
                                    ...
                                    <div class="info-select">
                                        ...
                                        <input type="text" placeholder="Drop Off Date" id="tf_dropoff_date" class="tf_dropoff_date" value="<?php echo !empty($_GET['dropoff_date']) ? sanitize_text_field( wp_unslash($_GET['dropoff_date'])) : esc_attr(gmdate('Y/m/d', strtotime('+2 day'))); ?>" />
                                    </div>
                                </div>
                            </div>
