                ...
                <div class="tf-archive-hotels-wrapper">
                    ...
                    <div class="tf-archive-top">
                        <h5 class="tf-total-results"><?php _e( "Found", "tourfic" ); ?>
                            <span><?php echo $post_count; ?></span> <?php _e( "of", "tourfic" ); ?> <?php echo $GLOBALS['wp_query']->found_posts; ?> <?php _e( "Hotels", "tourfic" ); ?></h5>
    ...
    <div class="tf_search_result">
        <div class="tf-action-top">
            ...
            <div class="tf-list-grid">
                <a href="#list-view" data-id="list-view" class="change-view <?php echo $tf_defult_views == "list" ? esc_attr( 'active' ) : ''; ?>" title="<?php _e( 'List View', 'tourfic' ); ?>"><i
                            class="fas fa-list"></i></a>
                <a href="#grid-view" data-id="grid-view" class="change-view <?php echo $tf_defult_views == "grid" ? esc_attr( 'active' ) : ''; ?>" title="<?php _e( 'Grid View', 'tourfic' ); ?>"><i
